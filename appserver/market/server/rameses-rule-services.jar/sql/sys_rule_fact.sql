...
[refactorConditionVar]
UPDATE sys_rule_condition_var
SET datatype = $P{newid}
WHERE datatype = $P{oldid}
...
[refactorDeployedRules]
UPDATE sys_rule_deployed 
SET ruletext = REPLACE( ruletext, $P{oldid}, $P{newid}  )
