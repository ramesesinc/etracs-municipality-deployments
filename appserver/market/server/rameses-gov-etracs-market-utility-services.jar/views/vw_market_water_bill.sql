DROP VIEW IF EXISTS vw_market_water_bill;
CREATE VIEW vw_market_water_bill AS 
SELECT
mb.*,
esa.acctno,
...
INNER JOIN market_water_subaccount esa ON eb.subacctid = esa.objid  

LEFT JOIN vw_market_water_prevbill prev ON mb.prevbillid = prev.objid
