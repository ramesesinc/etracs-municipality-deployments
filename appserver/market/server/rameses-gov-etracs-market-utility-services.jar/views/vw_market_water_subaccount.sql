DROP VIEW IF EXISTS vw_market_water_subaccount;
CREATE VIEW vw_market_water_subaccount AS 
SELECT
sa.*,
...
FROM market_water_subaccount sa
...
LEFT JOIN market_billgroup_unit mbgu ON (mu.objid = mbgu.unitid AND mbgu.billtype = 'WATER')