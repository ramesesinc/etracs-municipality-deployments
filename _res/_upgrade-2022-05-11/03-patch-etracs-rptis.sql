...
alter table rpttracking 
  ...
  add receivedby varchar(150),
  add remarks varchar(1000),
  add landcount int,
  add bldgcount int,
  add machcount int,
  add planttreecount int,
  add misccount int,
  add pin varchar(50)
;
