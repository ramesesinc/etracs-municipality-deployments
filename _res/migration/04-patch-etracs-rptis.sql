...
create proc usp_dropview(
  @viewname varchar(50)
)
as 
if (exists(select * from sysobjects where id = object_id(@viewname)))
begin 
...
if (exists(select * from sysobjects where id = object_id('zzz_ryordinance')))
begin 
  drop table zzz_ryordinance
end 
go 
...
from landrysetting l, zzz_ryordinance z
where l.ry = z.ry 
go 
...
update l set 
  l.ordinanceno = z.ordinanceno,
  l.ordinancedate = z.ordinancedate
from bldgrysetting l, zzz_ryordinance z
where l.ry = z.ry 
;
...
update l set 
  l.ordinanceno = z.ordinanceno,
  l.ordinancedate = z.ordinancedate
from machrysetting l, zzz_ryordinance z
where l.ry = z.ry 
;
...
update l set 
  l.ordinanceno = z.ordinanceno,
  l.ordinancedate = z.ordinancedate
from miscrysetting l, zzz_ryordinance z
where l.ry = z.ry 
;
...
update l set 
  l.ordinanceno = z.ordinanceno,
  l.ordinancedate = z.ordinancedate
from planttreerysetting l, zzz_ryordinance z
where l.ry = z.ry 
;
...
exec usp_droptable 'rptbill_ledger_account'
go 

exec usp_droptable 'rptbill_ledger_item'
go 

exec usp_droptable 'cashreceiptpayment_eor'
go 
...
*
=====================================================*/
exec usp_droptable 'batchgr_error'
go 

exec usp_droptable 'batchgr_items_forrevision'
go 

exec usp_droptable 'batchgr_log'
go 

exec usp_dropview 'vw_batchgr_error'
go 
...
update i set 
  ...
  i.org_objid = m.lguid,
  i.org_name = o.name 
from itemaccount i, municipality_taxaccount_mapping m, sys_org o  
...
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) 
VALUES ('appraiser', 'resection', 'Appraisal', 'state', '45', NULL, 'RPT', 'APPRAISER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) 
VALUES ('appraiser_chief', 'resection', 'Appraisal Approval', 'state', '55', NULL, 'RPT', 'APPRAISAL_CHIEF', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) 
VALUES ('approver', 'resection', 'Province Approval', 'state', '90', NULL, 'RPT', 'RECOMMENDER,ASSESSOR', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) 
VALUES ('assign-appraisal-chief', 'resection', 'For Appraisal Approval', 'state', '50', NULL, 'RPT', 'APPRAISAL_CHIEF', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) 
VALUES ('assign-appraiser', 'resection', 'For Appraisal', 'state', '40', NULL, 'RPT', 'APPRAISER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) 
VALUES ('assign-examiner', 'resection', 'For Examination', 'state', '10', NULL, 'RPT', 'EXAMINER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) 
VALUES ('assign-recommender', 'resection', 'For Recommending Approval', 'state', '70', NULL, 'RPT', 'RECOMMENDER,ASSESSOR', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) 
VALUES ('assign-taxmapper', 'resection', 'For Taxmapping', 'state', '20', NULL, 'RPT', 'TAXMAPPER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) 
VALUES ('assign-taxmapping-approval', 'resection', 'For Taxmapping Approval', 'state', '30', NULL, 'RPT', 'TAXMAPPER_CHIEF', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) 
VALUES ('end', 'resection', 'End', 'end', '1000', NULL, 'RPT', NULL, NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) 
VALUES ('examiner', 'resection', 'Examination', 'state', '15', NULL, 'RPT', 'EXAMINER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) 
VALUES ('forapproval', 'resection', 'For Province Approval', 'state', '85', NULL, 'RPT', 'RECOMMENDER,ASSESSOR', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) 
VALUES ('forprovapproval', 'resection', 'For Province Approval', 'state', '81', NULL, 'RPT', 'RECOMMENDER,ASSESSOR', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) 
VALUES ('forprovsubmission', 'resection', 'For Province Submission', 'state', '80', NULL, 'RPT', 'RECOMMENDER,ASSESSOR', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) 
VALUES ('provapprover', 'resection', 'Approved By Province', 'state', '96', NULL, 'RPT', 'APPROVER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) 
VALUES ('receiver', 'resection', 'Review and Verification', 'state', '5', NULL, 'RPT', 'RECEIVER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) 
VALUES ('recommender', 'resection', 'Recommending Approval', 'state', '75', NULL, 'RPT', 'RECOMMENDER,ASSESSOR', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) 
VALUES ('start', 'resection', 'Start', 'start', '1', NULL, 'RPT', NULL, NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) 
VALUES ('taxmapper', 'resection', 'Taxmapping', 'state', '25', NULL, 'RPT', 'TAXMAPPER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) 
VALUES ('taxmapper_chief', 'resection', 'Taxmapping Approval', 'state', '35', NULL, 'RPT', 'TAXMAPPER_CHIEF', NULL, NULL, NULL)
go


alter table sys_wf_transition add ui text 
go 

INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) 
VALUES ('appraiser', 'resection', 'returnexaminer', 'examiner', '46', NULL, '[caption:''Return to Examiner'', confirm:''Return to examiner?'', messagehandler:''default'']', NULL, NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) 
VALUES ('appraiser', 'resection', 'returntaxmapper', 'taxmapper', '45', NULL, '[caption:''Return to Taxmapper'', confirm:''Return to taxmapper?'', messagehandler:''default'']', NULL, NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) 
VALUES ('appraiser', 'resection', 'submit', 'assign-recommender', '47', NULL, '[caption:''Submit for Recommending Approval'', confirm:''Submit?'', messagehandler:''rptmessage:create'']', NULL, NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) 
VALUES ('approver', 'resection', '', 'processing-approval', '90', NULL, '[caption:''Manually Approve'', confirm:''Approve?'', messagehandler:''rptmessage:approval'']', '', NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) 
VALUES ('assign-appraiser', 'resection', '', 'appraiser', '40', NULL, '[caption:''Assign To Me'', confirm:''Assign task to you?'']', NULL, NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) 
VALUES ('assign-examiner', 'resection', '', 'examiner', '10', NULL, '[caption:''Assign To Me'', confirm:''Assign task to you?'']', NULL, NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) 
VALUES ('assign-recommender', 'resection', '', 'recommender', '70', NULL, '[caption:''Assign To Me'', confirm:''Assign task to you?'']', NULL, NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) 
VALUES ('assign-taxmapper', 'resection', '', 'taxmapper', '20', NULL, '[caption:''Assign To Me'', confirm:''Assign task to you?'']', NULL, NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) 
VALUES ('examiner', 'resection', 'returnreceiver', 'receiver', '15', NULL, '[caption:''Return to Receiver'', confirm:''Return to receiver?'', messagehandler:''default'']', NULL, NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) 
VALUES ('examiner', 'resection', 'submit', 'assign-taxmapper', '16', NULL, '[caption:''Submit for Taxmapping'', confirm:''Submit?'']', NULL, NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) 
VALUES ('forprovsubmission', 'resection', 'completed', 'approver', '81', NULL, '[caption:''Completed'', visible:false]', '', NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) 
VALUES ('forprovsubmission', 'resection', 'returnapprover', 'recommender', '80', NULL, '[caption:''Cancel Posting'', confirm:''Cancel posting record?'']', '', NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) 
VALUES ('provapprover', 'resection', 'backforprovapproval', 'approver', '95', '#{data != null && data.state != ''APROVED''}', '[caption:''Cancel Posting'', confirm:''Cancel posting record?'', visibleWhen=\"#{entity.state != ''APPROVED''}\"]', '', NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) 
VALUES ('provapprover', 'resection', 'completed', 'end', '100', NULL, '[caption:''Approved'', visible:false]', '', NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) 
VALUES ('receiver', 'resection', 'delete', 'end', '6', NULL, '[caption:''Delete'', confirm:''Delete?'', closeonend:true]', NULL, NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) 
VALUES ('receiver', 'resection', 'submit', 'assign-examiner', '5', NULL, '[caption:''Submit For Examination'', confirm:''Submit?'']', NULL, NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) 
VALUES ('recommender', 'resection', 'returnappraiser', 'appraiser', '77', NULL, '[caption:''Return to Appraiser'', confirm:''Return to appraiser?'', messagehandler:''default'']', NULL, NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) 
VALUES ('recommender', 'resection', 'returnexaminer', 'examiner', '75', NULL, '[caption:''Return to Examiner'', confirm:''Return to examiner?'', messagehandler:''default'']', NULL, NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) 
VALUES ('recommender', 'resection', 'returntaxmapper', 'taxmapper', '76', NULL, '[caption:''Return to Taxmapper'', confirm:''Return to taxmapper?'', messagehandler:''default'']', NULL, NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) 
VALUES ('recommender', 'resection', 'submit', 'forprovsubmission', '78', NULL, '[caption:''Submit to Province'', confirm:''Submit to Province?'', messagehandler:''rptmessage:create'']', '', NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) 
VALUES ('start', 'resection', '', 'receiver', '1', NULL, NULL, NULL, NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) 
VALUES ('taxmapper', 'resection', 'returnexaminer', 'examiner', '26', NULL, '[caption:''Return to Examiner'', confirm:''Return to examiner?'', messagehandler:''default'']', NULL, NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) 
VALUES ('taxmapper', 'resection', 'returnreceiver', 'receiver', '25', NULL, '[caption:''Return to Receiver'', confirm:''Return to receiver?'', messagehandler:''default'']', '', NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) 
VALUES ('taxmapper', 'resection', 'submit', 'assign-appraiser', '26', NULL, '[caption:''Submit for Appraisal'', confirm:''Submit?'', messagehandler:''rptmessage:create'']', NULL, NULL, NULL)
go
...
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('start', 'batchgr', 'Start', 'start', '1', NULL, 'RPT', NULL, NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('receiver', 'batchgr', 'Review and Verification', 'state', '5', NULL, 'RPT', 'RECEIVER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('assign-examiner', 'batchgr', 'For Examination', 'state', '10', NULL, 'RPT', 'EXAMINER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('examiner', 'batchgr', 'Examination', 'state', '15', NULL, 'RPT', 'EXAMINER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('assign-taxmapper', 'batchgr', 'For Taxmapping', 'state', '20', NULL, 'RPT', 'TAXMAPPER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('taxmapper', 'batchgr', 'Taxmapping', 'state', '25', NULL, 'RPT', 'TAXMAPPER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('assign-taxmapping-approval', 'batchgr', 'For Taxmapping Approval', 'state', '30', NULL, 'RPT', 'TAXMAPPER_CHIEF', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('taxmapper_chief', 'batchgr', 'Taxmapping Approval', 'state', '35', NULL, 'RPT', 'TAXMAPPER_CHIEF', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('assign-appraiser', 'batchgr', 'For Appraisal', 'state', '40', NULL, 'RPT', 'APPRAISER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('appraiser', 'batchgr', 'Appraisal', 'state', '45', NULL, 'RPT', 'APPRAISER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('assign-appraisal-chief', 'batchgr', 'For Appraisal Approval', 'state', '50', NULL, 'RPT', 'APPRAISAL_CHIEF', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('appraiser_chief', 'batchgr', 'Appraisal Approval', 'state', '55', NULL, 'RPT', 'APPRAISAL_CHIEF', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('assign-recommender', 'batchgr', 'For Recommending Approval', 'state', '70', NULL, 'RPT', 'RECOMMENDER,ASSESSOR', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('recommender', 'batchgr', 'Recommending Approval', 'state', '75', NULL, 'RPT', 'RECOMMENDER,ASSESSOR', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('forprovsubmission', 'batchgr', 'For Province Submission', 'state', '80', NULL, 'RPT', 'RECOMMENDER,ASSESSOR', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('forprovapproval', 'batchgr', 'For Province Approval', 'state', '81', NULL, 'RPT', 'RECOMMENDER,ASSESSOR', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('forapproval', 'batchgr', 'For Province Approval', 'state', '85', NULL, 'RPT', 'RECOMMENDER,ASSESSOR', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('approver', 'batchgr', 'Province Approval', 'state', '90', NULL, 'RPT', 'RECOMMENDER,ASSESSOR', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('cityapprover', 'batchgr', 'Assessor Approval', 'state', '95', NULL, 'RPT', 'APPROVER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('provapprover', 'batchgr', 'Approved By Province', 'state', '96', NULL, 'RPT', 'APPROVER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('end', 'batchgr', 'End', 'end', '1000', NULL, 'RPT', NULL, NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('start', 'cancelledfaas', 'Start', 'start', '1', NULL, 'RPT', NULL, NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('assign-receiver', 'cancelledfaas', 'Assign Receiver', 'state', '2', '0', 'RPT', 'RECEIVER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('receiver', 'cancelledfaas', 'Review and Verification', 'state', '5', NULL, 'RPT', 'RECEIVER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('assign-examiner', 'cancelledfaas', 'For Examination', 'state', '10', NULL, 'RPT', 'EXAMINER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('examiner', 'cancelledfaas', 'Examination', 'state', '15', NULL, 'RPT', 'EXAMINER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('assign-taxmapper', 'cancelledfaas', 'For Taxmapping', 'state', '20', NULL, 'RPT', 'TAXMAPPER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('assign-provtaxmapperchief', 'cancelledfaas', 'For Taxmapping Approval', 'state', '25', '0', 'RPT', 'TAXMAPPER_CHIEF', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('taxmapper', 'cancelledfaas', 'Taxmapping', 'state', '25', NULL, 'RPT', 'TAXMAPPER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('assign-taxmapping-approval', 'cancelledfaas', 'For Taxmapper Chief Approval', 'state', '30', NULL, 'RPT', 'TAXMAPPER_CHIEF', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('taxmapper_chief', 'cancelledfaas', 'Taxmapping Approval', 'state', '35', NULL, 'RPT', 'TAXMAPPER_CHIEF', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('provtaxmapperchief', 'cancelledfaas', 'Taxmapping Chief Approval', 'state', '35', NULL, 'RPT', 'TAXMAPPER_CHIEF', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('assign-appraiser', 'cancelledfaas', 'For Appraisal', 'state', '40', NULL, 'RPT', 'APPRAISER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('appraiser', 'cancelledfaas', 'Appraisal', 'state', '45', NULL, 'RPT', 'APPRAISER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('assign-appraisal-chief', 'cancelledfaas', 'For Appraisal Chief Approval', 'state', '50', NULL, 'RPT', 'APPRAISAL_CHIEF', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('appraiser_chief', 'cancelledfaas', 'Appraisal Chief Approval', 'state', '55', NULL, 'RPT', 'APPRAISAL_CHIEF', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('provappraiserchief', 'cancelledfaas', 'Appraisal Chief Approval', 'state', '55', NULL, 'RPT', 'APPRAISAL_CHIEF', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('assign-recommender', 'cancelledfaas', 'For Recommending Approval', 'state', '70', NULL, 'RPT', 'RECOMMENDER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('assign-provrecommender', 'cancelledfaas', 'For Recommending Approval', 'state', '71', NULL, 'RPT', 'RECOMMENDER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('recommender', 'cancelledfaas', 'Recommending Approval', 'state', '75', NULL, 'RPT', 'RECOMMENDER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('provrecommender', 'cancelledfaas', 'Recommending Approval', 'state', '76', NULL, 'RPT', 'RECOMMENDER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('assign-approver', 'cancelledfaas', 'For Assessor Approval', 'state', '80', NULL, 'RPT', 'APPROVER,ASSESSOR', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('approver', 'cancelledfaas', 'Assessor Approval', 'state', '85', NULL, 'RPT', 'APPROVER,ASSESSOR', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('assign-provtaxmapper', 'cancelledfaas', 'For Taxmapping', 'state', '200', '0', 'RPT', 'TAXMAPPER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('assign-provappraiserchief', 'cancelledfaas', 'For Appraisal Chief Approval', 'state', '201', '0', 'RPT', 'APPRAISAL_CHIEF', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('provtaxmapper', 'cancelledfaas', 'Taxmapping', 'state', '205', '0', 'RPT', 'TAXMAPPER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('assign-provappraiser', 'cancelledfaas', 'For Appraisal', 'state', '210', '0', 'RPT', 'APPRAISER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('provappraiser', 'cancelledfaas', 'Appraisal', 'state', '215', '0', 'RPT', 'APPRAISER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('assign-provapprover', 'cancelledfaas', 'For Provincial Assessor Approval', 'state', '220', '0', 'RPT', 'APPROVER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('provapprover', 'cancelledfaas', 'Provincial Assessor Approval', 'state', '230', NULL, 'RPT', 'APPROVER,ASSESSOR', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('end', 'cancelledfaas', 'End', 'end', '1000', NULL, 'RPT', NULL, NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('start', 'consolidation', 'Start', 'start', '1', NULL, 'RPT', NULL, NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('receiver', 'consolidation', 'Review and Verification', 'state', '5', NULL, 'RPT', 'RECEIVER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('assign-examiner', 'consolidation', 'For Examination', 'state', '10', NULL, 'RPT', 'EXAMINER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('examiner', 'consolidation', 'Examination', 'state', '15', NULL, 'RPT', 'EXAMINER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('assign-taxmapper', 'consolidation', 'For Taxmapping', 'state', '20', NULL, 'RPT', 'TAXMAPPER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('taxmapper', 'consolidation', 'Taxmapping', 'state', '25', NULL, 'RPT', 'TAXMAPPER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('assign-taxmapping-approval', 'consolidation', 'For Taxmapping Approval', 'state', '30', NULL, 'RPT', 'TAXMAPPER_CHIEF', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('taxmapper_chief', 'consolidation', 'Taxmapping Approval', 'state', '35', NULL, 'RPT', 'TAXMAPPER_CHIEF', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('assign-appraiser', 'consolidation', 'For Appraisal', 'state', '40', NULL, 'RPT', 'APPRAISER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('appraiser', 'consolidation', 'Appraisal', 'state', '45', NULL, 'RPT', 'APPRAISER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('assign-appraisal-chief', 'consolidation', 'For Appraisal Approval', 'state', '50', NULL, 'RPT', 'APPRAISAL_CHIEF', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('appraiser_chief', 'consolidation', 'Appraisal Approval', 'state', '55', NULL, 'RPT', 'APPRAISAL_CHIEF', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('assign-recommender', 'consolidation', 'For Recommending Approval', 'state', '70', NULL, 'RPT', 'RECOMMENDER,ASSESSOR', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('recommender', 'consolidation', 'Recommending Approval', 'state', '75', NULL, 'RPT', 'RECOMMENDER,ASSESSOR', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('forprovsubmission', 'consolidation', 'For Province Submission', 'state', '80', NULL, 'RPT', 'RECOMMENDER,ASSESSOR', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('forprovapproval', 'consolidation', 'For Province Approval', 'state', '81', NULL, 'RPT', 'RECOMMENDER,ASSESSOR', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('forapproval', 'consolidation', 'For Province Approval', 'state', '85', NULL, 'RPT', 'RECOMMENDER,ASSESSOR', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('approver', 'consolidation', 'Province Approval', 'state', '90', NULL, 'RPT', 'RECOMMENDER,ASSESSOR', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('provapprover', 'consolidation', 'Approved By Province', 'state', '96', NULL, 'RPT', 'APPROVER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('end', 'consolidation', 'End', 'end', '1000', NULL, 'RPT', NULL, NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('start', 'faas', 'Start', 'start', '1', NULL, 'RPT', NULL, NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('assign-receiver', 'faas', 'Assign Receiver', 'state', '2', '0', 'RPT', 'RECEIVER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('receiver', 'faas', 'Review and Verification', 'state', '5', NULL, 'RPT', 'RECEIVER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('assign-examiner', 'faas', 'For Examination', 'state', '10', NULL, 'RPT', 'EXAMINER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('examiner', 'faas', 'Examination', 'state', '15', NULL, 'RPT', 'EXAMINER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('assign-taxmapper', 'faas', 'For Taxmapping', 'state', '20', NULL, 'RPT', 'TAXMAPPER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('assign-provtaxmapperchief', 'faas', 'For Taxmapping Approval', 'state', '25', '0', 'RPT', 'TAXMAPPER_CHIEF', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('taxmapper', 'faas', 'Taxmapping', 'state', '25', NULL, 'RPT', 'TAXMAPPER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('assign-taxmapping-approval', 'faas', 'For Taxmapper Chief Approval', 'state', '30', NULL, 'RPT', 'TAXMAPPER_CHIEF', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('taxmapper_chief', 'faas', 'Taxmapping Approval', 'state', '35', NULL, 'RPT', 'TAXMAPPER_CHIEF', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('provtaxmapperchief', 'faas', 'Taxmapping Chief Approval', 'state', '35', NULL, 'RPT', 'TAXMAPPER_CHIEF', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('assign-appraiser', 'faas', 'For Appraisal', 'state', '40', NULL, 'RPT', 'APPRAISER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('appraiser', 'faas', 'Appraisal', 'state', '45', NULL, 'RPT', 'APPRAISER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('assign-appraisal-chief', 'faas', 'For Appraisal Chief Approval', 'state', '50', NULL, 'RPT', 'APPRAISAL_CHIEF', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('appraiser_chief', 'faas', 'Appraisal Chief Approval', 'state', '55', NULL, 'RPT', 'APPRAISAL_CHIEF', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('provappraiserchief', 'faas', 'Appraisal Chief Approval', 'state', '55', NULL, 'RPT', 'APPRAISAL_CHIEF', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('assign-recommender', 'faas', 'For Recommending Approval', 'state', '70', NULL, 'RPT', 'RECOMMENDER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('assign-provrecommender', 'faas', 'For Recommending Approval', 'state', '71', NULL, 'RPT', 'RECOMMENDER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('recommender', 'faas', 'Recommending Approval', 'state', '75', NULL, 'RPT', 'RECOMMENDER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('provrecommender', 'faas', 'Recommending Approval', 'state', '76', NULL, 'RPT', 'RECOMMENDER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('assign-approver', 'faas', 'For Assessor Approval', 'state', '80', NULL, 'RPT', 'APPROVER,ASSESSOR', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('approver', 'faas', 'Assessor Approval', 'state', '85', NULL, 'RPT', 'APPROVER,ASSESSOR', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('assign-provtaxmapper', 'faas', 'For Taxmapping', 'state', '200', '0', 'RPT', 'TAXMAPPER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('assign-provappraiserchief', 'faas', 'For Appraisal Chief Approval', 'state', '201', '0', 'RPT', 'APPRAISAL_CHIEF', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('provtaxmapper', 'faas', 'Taxmapping', 'state', '205', '0', 'RPT', 'TAXMAPPER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('assign-provappraiser', 'faas', 'For Appraisal', 'state', '210', '0', 'RPT', 'APPRAISER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('provappraiser', 'faas', 'Appraisal', 'state', '215', '0', 'RPT', 'APPRAISER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('assign-provapprover', 'faas', 'For Provincial Assessor Approval', 'state', '220', '0', 'RPT', 'APPROVER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('provapprover', 'faas', 'Provincial Assessor Approval', 'state', '230', NULL, 'RPT', 'APPROVER,ASSESSOR', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('end', 'faas', 'End', 'end', '1000', NULL, 'RPT', NULL, NULL, NULL, NULL)
go
...
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('start', 'subdivision', 'Start', 'start', '1', NULL, 'RPT', NULL, NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('receiver', 'subdivision', 'Review and Verification', 'state', '5', NULL, 'RPT', 'RECEIVER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('assign-examiner', 'subdivision', 'For Examination', 'state', '10', NULL, 'RPT', 'EXAMINER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('examiner', 'subdivision', 'Examination', 'state', '15', NULL, 'RPT', 'EXAMINER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('assign-taxmapper', 'subdivision', 'For Taxmapping', 'state', '20', NULL, 'RPT', 'TAXMAPPER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('taxmapper', 'subdivision', 'Taxmapping', 'state', '25', NULL, 'RPT', 'TAXMAPPER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('assign-taxmapping-approval', 'subdivision', 'For Taxmapping Approval', 'state', '30', NULL, 'RPT', 'TAXMAPPER_CHIEF', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('taxmapper_chief', 'subdivision', 'Taxmapping Approval', 'state', '35', NULL, 'RPT', 'TAXMAPPER_CHIEF', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('assign-appraiser', 'subdivision', 'For Appraisal', 'state', '40', NULL, 'RPT', 'APPRAISER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('appraiser', 'subdivision', 'Appraisal', 'state', '45', NULL, 'RPT', 'APPRAISER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('assign-appraisal-chief', 'subdivision', 'For Appraisal Approval', 'state', '50', NULL, 'RPT', 'APPRAISAL_CHIEF', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('appraiser_chief', 'subdivision', 'Appraisal Approval', 'state', '55', NULL, 'RPT', 'APPRAISAL_CHIEF', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('assign-recommender', 'subdivision', 'For Recommending Approval', 'state', '70', NULL, 'RPT', 'RECOMMENDER,ASSESSOR', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('recommender', 'subdivision', 'Recommending Approval', 'state', '75', NULL, 'RPT', 'RECOMMENDER,ASSESSOR', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('forprovsubmission', 'subdivision', 'For Province Submission', 'state', '80', NULL, 'RPT', 'RECOMMENDER,ASSESSOR', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('forprovapproval', 'subdivision', 'For Province Approval', 'state', '81', NULL, 'RPT', 'RECOMMENDER,ASSESSOR', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('forapproval', 'subdivision', 'For Province Approval', 'state', '85', NULL, 'RPT', 'RECOMMENDER,ASSESSOR', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('approver', 'subdivision', 'Province Approval', 'state', '90', NULL, 'RPT', 'RECOMMENDER,ASSESSOR', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('provapprover', 'subdivision', 'Approved By Province', 'state', '96', NULL, 'RPT', 'APPROVER', NULL, NULL, NULL)
go
INSERT INTO sys_wf_node ([name], [processname], [title], [nodetype], [idx], [salience], [domain], [role], [ui], [properties], [tracktime]) VALUES ('end', 'subdivision', 'End', 'end', '1000', NULL, 'RPT', NULL, NULL, NULL, NULL)
go
...
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) VALUES ('provapprover', 'batchgr', 'completed', 'end', '100', NULL, '[caption:''Approved'', visible:false]', NULL, NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) VALUES ('start', 'cancelledfaas', '', 'receiver', '1', NULL, NULL, NULL, NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) VALUES ('receiver', 'cancelledfaas', 'delete', 'end', '5', NULL, '[caption:''Delete'', confirm:''Delete record?'', closeonend:true]', NULL, NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) VALUES ('receiver', 'cancelledfaas', 'submit', 'assign-taxmapper', '16', NULL, '[caption:''Submit for Taxmapping'', confirm:''Submit for taxmapping?'', messagehandler:''default'']', NULL, NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) VALUES ('assign-taxmapper', 'cancelledfaas', '', 'taxmapper', '20', NULL, '[caption:''Assign To Me'', confirm:''Assign task to you?'']', NULL, NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) VALUES ('taxmapper', 'cancelledfaas', 'return_receiver', 'receiver', '25', NULL, '[caption:''Return to Receiver'',confirm:''Return to receiver?'',messagehandler:''default'']', NULL, NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) VALUES ('taxmapper', 'cancelledfaas', 'submit', 'assign-recommender', '27', NULL, '[caption:''Submit for Recommending Approval'', confirm:''Submit?'', messagehandler:''rptmessage:create'']', NULL, NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) VALUES ('assign-recommender', 'cancelledfaas', '', 'recommender', '70', NULL, '[caption:''Assign To Me'', confirm:''Assign task to you?'']', NULL, NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) VALUES ('recommender', 'cancelledfaas', 'return_receiver', 'receiver', '71', NULL, '[caption:''Return to Receiver'',confirm:''Return to receiver?'', messagehandler:''default'']', '', NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) VALUES ('recommender', 'cancelledfaas', 'return_appraiser', 'appraiser', '72', NULL, '[caption:''Return to Appraiser'',confirm:''Return to appraiser?'', messagehandler:''default'']', NULL, NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) VALUES ('recommender', 'cancelledfaas', 'return_taxmapper', 'taxmapper', '73', NULL, '[caption:''Return to Taxmapper'',confirm:''Return to taxmapper?'', messagehandler:''default'']', NULL, NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) VALUES ('recommender', 'cancelledfaas', 'submit_approver', 'assign-approver', '74', NULL, '[caption:''Submit for Assessor Approval'', confirm:''Submit to assessor approval?'', messagehandler:''default'']', NULL, NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) VALUES ('recommender', 'cancelledfaas', 'submit_to_province', 'approver', '75', NULL, '[caption:''Submit to Province'', confirm:''Submit to Province?'', messagehandler:''rptmessage:create'']', NULL, NULL, NULL)
go
...
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) VALUES ('approver', 'cancelledfaas', 'approve', 'end', '110', NULL, '[caption:''Manually Approve'',confirm:''Manually approve cancellation?'']', NULL, NULL, NULL)
go
...
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) VALUES ('receiver', 'consolidation', 'submit', 'assign-examiner', '5', NULL, '[caption:''Submit For Examination'', confirm:''Submit?'']', NULL, NULL, NULL)
go
...
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) VALUES ('taxmapper', 'consolidation', 'returnreceiver', 'receiver', '25', NULL, '[caption:''Return to Receiver'', confirm:''Return to receiver?'', messagehandler:''default'']', NULL, NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) VALUES ('taxmapper', 'consolidation', 'submit', 'assign-appraiser', '26', NULL, '[caption:''Submit for Appraisal'', confirm:''Submit?'', messagehandler:''rptmessage:create'']', NULL, NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) VALUES ('taxmapper', 'consolidation', 'returnexaminer', 'examiner', '26', NULL, '[caption:''Return to Examiner'', confirm:''Return to examiner?'', messagehandler:''default'']', NULL, NULL, NULL)
go
...
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) VALUES ('appraiser', 'consolidation', 'submit', 'assign-recommender', '47', NULL, '[caption:''Submit for Recommending Approval'', confirm:''Submit?'', messagehandler:''rptmessage:create'']', NULL, NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) VALUES ('appraiser', 'consolidation', 'submit', 'forprovsubmission', '50', NULL, '[caption:''Submit to Province'', confirm:''Submit to Province?'', messagehandler:''rptmessage:create'']', '', NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) VALUES ('assign-recommender', 'consolidation', '', 'recommender', '70', NULL, '[caption:''Assign To Me'', confirm:''Assign task to you?'']', NULL, NULL, NULL)
go
...
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) VALUES ('recommender', 'consolidation', 'submit', 'forprovsubmission', '78', NULL, '[caption:''Submit to Province'', confirm:''Submit to Province?'', messagehandler:''rptmessage:create'']', NULL, NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) VALUES ('forprovsubmission', 'consolidation', 'returnapprover', 'recommender', '80', NULL, '[caption:''Cancel Posting'', confirm:''Cancel posting record?'']', NULL, NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) VALUES ('forprovsubmission', 'consolidation', 'completed', 'approver', '81', NULL, '[caption:''Completed'', visible:false]', NULL, NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) VALUES ('approver', 'consolidation', '', 'provapprover', '90', NULL, '[caption:''Manually Approve Consolidation'', confirm:''Approve?'', messagehandler:''rptmessage:approval'']', NULL, NULL, NULL)
go
...
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) VALUES ('receiver', 'faas', 'submit', 'assign-taxmapper', '16', NULL, '[caption:''Submit for Taxmapping'', confirm:''Submit for taxmapping?'', messagehandler:''default'']', NULL, NULL, NULL)
go
...
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) VALUES ('taxmapper', 'faas', 'submit', 'assign-appraiser', '27', NULL, '[caption:''Submit for Appraisal'', confirm:''Submit for appraisal?'', messagehandler:''rptmessage:create'']', NULL, NULL, NULL)
go
...
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) VALUES ('appraiser', 'faas', 'return_receiver', 'receiver', '45', NULL, '[caption:''Return to Receiver'',confirm:''Return to receiver?'', messagehandler:''default'']', NULL, NULL, NULL)
go
...
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) VALUES ('appraiser', 'faas', 'submit', 'assign-recommender', '47', NULL, '[caption:''Submit for Recommending Approval'', confirm:''Submit for recommending approval?'', messagehandler:''rptmessage:create'']', NULL, NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) VALUES ('appraiser', 'faas', 'submit_to_province', 'provapprover', '50', '', '[caption:''Submit to Province'', confirm:''Submit to Province?'', messagehandler:''rptmessage:create'']', '', NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) VALUES ('assign-recommender', 'faas', '', 'recommender', '70', NULL, '[caption:''Assign To Me'', confirm:''Assign task to you?'']', NULL, NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) VALUES ('recommender', 'faas', 'return_appraiser', 'appraiser', '72', NULL, '[caption:''Return to Appraiser'',confirm:''Return to appraiser?'', messagehandler:''default'']', NULL, NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) VALUES ('recommender', 'faas', 'return_taxmapper', 'taxmapper', '73', NULL, '[caption:''Return to Taxmapper'',confirm:''Return to taxmapper?'', messagehandler:''default'']', NULL, NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) VALUES ('recommender', 'faas', 'submit_approver', 'assign-approver', '74', NULL, '[caption:''Submit for Assessor Approval'', confirm:''Submit to assessor approval?'', messagehandler:''default'']', NULL, NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) VALUES ('recommender', 'faas', 'submit_to_province', 'provapprover', '75', NULL, '[caption:''Submit to Province'', confirm:''Submit to Province?'', messagehandler:''rptmessage:create'']', NULL, NULL, NULL)
go
...
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) VALUES ('approver', 'faas', 'return_recommender', 'recommender', '85', NULL, '[caption:''Return to Recommender'',confirm:''Return to Recommender?'', messagehandler:''default'']', NULL, NULL, NULL)
go
...
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) VALUES ('approver', 'faas', 'approve', 'end', '100', NULL, '[caption:''Approve'', confirm:''Approve FAAS?'', closeonend:false, messagehandler:''default'']', NULL, NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) VALUES ('provapprover', 'faas', 'approve', 'end', '110', NULL, '[caption:''Approve'', visible:false]', NULL, NULL, NULL)
go
...
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) VALUES ('receiver', 'subdivision', 'submit', 'assign-examiner', '5', NULL, '[caption:''Submit For Examination'', confirm:''Submit?'']', NULL, NULL, NULL)
go
...
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) VALUES ('taxmapper', 'subdivision', 'returnreceiver', 'receiver', '25', NULL, '[caption:''Return to Receiver'', confirm:''Return to receiver?'', messagehandler:''default'']', '', NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) VALUES ('taxmapper', 'subdivision', 'submit', 'assign-appraiser', '26', NULL, '[caption:''Submit for Appraisal'', confirm:''Submit?'', messagehandler:''rptmessage:create'']', NULL, NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) VALUES ('taxmapper', 'subdivision', 'returnexaminer', 'examiner', '26', NULL, '[caption:''Return to Examiner'', confirm:''Return to examiner?'', messagehandler:''default'']', NULL, NULL, NULL)
go
...
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) VALUES ('appraiser', 'subdivision', 'submit_recommender', 'assign-recommender', '47', NULL, '[caption:''Submit for Recommending Approval'', confirm:''Submit?'', messagehandler:''rptmessage:create'']', NULL, NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) VALUES ('appraiser', 'subdivision', 'submit_province', 'forprovsubmission', '50', NULL, '[caption:''Submit to Province'', confirm:''Submit to Province?'', messagehandler:''rptmessage:create'']', '', NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) VALUES ('assign-recommender', 'subdivision', '', 'recommender', '70', NULL, '[caption:''Assign To Me'', confirm:''Assign task to you?'']', NULL, NULL, NULL)
go
...
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) VALUES ('recommender', 'subdivision', 'submit', 'forprovsubmission', '78', NULL, '[caption:''Submit to Province'', confirm:''Submit to Province?'', messagehandler:''rptmessage:create'']', '', NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) VALUES ('forprovsubmission', 'subdivision', 'returnapprover', 'recommender', '80', NULL, '[caption:''Cancel Posting'', confirm:''Cancel posting record?'']', '', NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) VALUES ('forprovsubmission', 'subdivision', 'completed', 'approver', '81', NULL, '[caption:''Completed'', visible:false]', '', NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) VALUES ('approver', 'subdivision', '', 'provapprover', '90', NULL, '[caption:''Manually Approve Subdivision'', confirm:''Approve?'', messagehandler:''rptmessage:approval'']', '', NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) VALUES ('provapprover', 'subdivision', 'backforprovapproval', 'approver', '95', NULL, '[caption:''Cancel Posting'', confirm:''Cancel posting record?'']', '', NULL, NULL)
go
INSERT INTO sys_wf_transition ([parentid], [processname], [action], [to], [idx], [eval], [properties], [permission], [caption], [ui]) VALUES ('provapprover', 'subdivision', 'completed', 'end', '100', NULL, '[caption:''Approved'', visible:false]', '', NULL, NULL)
go
...
go
INSERT INTO sys_rule ([objid], [state], [name], [ruleset], [rulegroup], [title], [description], [salience], [effectivefrom], [effectiveto], [dtfiled], [user_objid], [user_name], [noloop], [_ukey]) VALUES ('RUL-2486b0ca:146fff66c3e:-4697', 'DEPLOYED', 'CALC_DEPRECATION_RATE_FROM_SKED', 'bldgassessment', 'BEFORE-DEPRECIATON', 'CALC DEPRECATION RATE FROM SKED', NULL, '50000', NULL, NULL, '2014-12-16 12:59:15.000', 'USR7e15465b:14a51353b1a:-7fb7', 'ADMIN', '1', '')
go
...
go
INSERT INTO sys_rule ([objid], [state], [name], [ruleset], [rulegroup], [title], [description], [salience], [effectivefrom], [effectiveto], [dtfiled], [user_objid], [user_name], [noloop], [_ukey]) VALUES ('RUL-3c38a261:17ad6957651:-33ca', 'DEPLOYED', 'PDIC_RULE_01', 'rptbilling', 'before_misc', 'PDIC RULE 01', NULL, '50000', NULL, NULL, '2021-07-24 14:53:23.863', 'USR-ADMIN', 'ADMIN', '1', NULL)
go
INSERT INTO sys_rule ([objid], [state], [name], [ruleset], [rulegroup], [title], [description], [salience], [effectivefrom], [effectiveto], [dtfiled], [user_objid], [user_name], [noloop], [_ukey]) VALUES ('RUL-3c38a261:17ad6957651:-364e', 'DEPLOYED', 'TOTAL_PRIOR', 'rptbilling', 'SUMMARY', 'TOTAL PRIOR', NULL, '50000', NULL, NULL, '2021-07-24 14:50:50.460', 'USR-ADMIN', 'ADMIN', '1', NULL)
go
INSERT INTO sys_rule ([objid], [state], [name], [ruleset], [rulegroup], [title], [description], [salience], [effectivefrom], [effectiveto], [dtfiled], [user_objid], [user_name], [noloop], [_ukey]) VALUES ('RUL-3c38a261:17ad6957651:-3b26', 'DEPLOYED', 'DISCOUNT_ADJUSTMENT_SP_ORD_2021', 'rptbilling', 'AFTER_DISCOUNT', 'DISCOUNT ADJUSTMENT SP ORD 2021	', NULL, '40000', NULL, NULL, '2021-07-24 14:47:27.000', 'USR-ADMIN', 'ADMIN', '1', NULL)
go
INSERT INTO sys_rule ([objid], [state], [name], [ruleset], [rulegroup], [title], [description], [salience], [effectivefrom], [effectiveto], [dtfiled], [user_objid], [user_name], [noloop], [_ukey]) VALUES ('RUL-3c38a261:17ad6957651:-3bf9', 'DEPLOYED', 'DISCOUNT_WITH_ARREAR_ZERO_ADJUSTMENT', 'rptbilling', 'AFTER_DISCOUNT', 'DISCOUNT WITH ARREAR ZERO ADJUSTMENT', NULL, '50000', NULL, NULL, '2021-07-24 14:46:01.017', 'USR-ADMIN', 'ADMIN', '1', NULL)
go
INSERT INTO sys_rule ([objid], [state], [name], [ruleset], [rulegroup], [title], [description], [salience], [effectivefrom], [effectiveto], [dtfiled], [user_objid], [user_name], [noloop], [_ukey]) VALUES ('RUL-3c38a261:17ad6957651:-3fd6', 'DEPLOYED', 'DISCOUNT_WITH_ARREAR_ZERO_ADJUSTMENT_2015', 'rptbilling', 'AFTER_DISCOUNT', 'DISCOUNT WITH ARREAR ZERO ADJUSTMENT 2015', NULL, '50000', NULL, NULL, '2021-07-24 14:43:53.040', 'USR-ADMIN', 'ADMIN', '1', NULL)
go
INSERT INTO sys_rule ([objid], [state], [name], [ruleset], [rulegroup], [title], [description], [salience], [effectivefrom], [effectiveto], [dtfiled], [user_objid], [user_name], [noloop], [_ukey]) VALUES ('RUL-3c38a261:17ad6957651:-4180', 'DEPLOYED', 'NO_DISCOUNT_ND', 'rptbilling', 'AFTER_DISCOUNT', 'NO DISCOUNT ND', NULL, '50000', NULL, NULL, '2021-07-24 14:42:45.070', 'USR-ADMIN', 'ADMIN', '1', NULL)
go
INSERT INTO sys_rule ([objid], [state], [name], [ruleset], [rulegroup], [title], [description], [salience], [effectivefrom], [effectiveto], [dtfiled], [user_objid], [user_name], [noloop], [_ukey]) VALUES ('RUL-3c38a261:17ad6957651:-4513', 'DEPLOYED', 'PENALTY_ADJUSTMENT_SP_ORD_2021', 'rptbilling', 'AFTER_PENALTY', 'PENALTY ADJUSTMENT SP ORD 2021', NULL, '40000', NULL, NULL, '2021-07-24 14:40:30.267', 'USR-ADMIN', 'ADMIN', '1', NULL)
go
INSERT INTO sys_rule ([objid], [state], [name], [ruleset], [rulegroup], [title], [description], [salience], [effectivefrom], [effectiveto], [dtfiled], [user_objid], [user_name], [noloop], [_ukey]) VALUES ('RUL-3c38a261:17ad6957651:-4699', 'DEPLOYED', 'NO_PENALTY_BACKTAX', 'rptbilling', 'AFTER_PENALTY', 'NO PENALTY BACKTAX', NULL, '50000', NULL, NULL, '2021-07-24 14:39:25.457', 'USR-ADMIN', 'ADMIN', '1', NULL)
go
INSERT INTO sys_rule ([objid], [state], [name], [ruleset], [rulegroup], [title], [description], [salience], [effectivefrom], [effectiveto], [dtfiled], [user_objid], [user_name], [noloop], [_ukey]) VALUES ('RUL-3c38a261:17ad6957651:-48b3', 'DEPLOYED', 'NO_PENALTY_RECLASSED', 'rptbilling', 'AFTER_PENALTY', 'NO PENALTY RECLASSED', NULL, '50000', NULL, NULL, '2021-07-24 14:38:18.503', 'USR-ADMIN', 'ADMIN', '1', NULL)
go
INSERT INTO sys_rule ([objid], [state], [name], [ruleset], [rulegroup], [title], [description], [salience], [effectivefrom], [effectiveto], [dtfiled], [user_objid], [user_name], [noloop], [_ukey]) VALUES ('RUL-3c38a261:17ad6957651:-4b97', 'DEPLOYED', 'NO_PENALTY_TAX_DIFFERENCE', 'rptbilling', 'AFTER_PENALTY', 'NO PENALTY TAX DIFFERENCE', NULL, '50000', NULL, NULL, '2021-07-24 14:36:52.443', 'USR-ADMIN', 'ADMIN', '1', NULL)
go
INSERT INTO sys_rule ([objid], [state], [name], [ruleset], [rulegroup], [title], [description], [salience], [effectivefrom], [effectiveto], [dtfiled], [user_objid], [user_name], [noloop], [_ukey]) VALUES ('RUL-3c38a261:17ad6957651:-5551', 'DEPLOYED', 'DISCOUNT_CURRENT_YEAR', 'rptbilling', 'DISCOUNT', 'DISCOUNT CURRENT YEAR', NULL, '50000', NULL, NULL, '2021-07-24 14:29:48.323', 'USR-ADMIN', 'ADMIN', '1', NULL)
go
INSERT INTO sys_rule ([objid], [state], [name], [ruleset], [rulegroup], [title], [description], [salience], [effectivefrom], [effectiveto], [dtfiled], [user_objid], [user_name], [noloop], [_ukey]) VALUES ('RUL-3c38a261:17ad6957651:-5dbd', 'DEPLOYED', 'PENALTY_CURRENT_YEAR', 'rptbilling', 'PENALTY', 'PENALTY CURRENT YEAR', NULL, '50000', NULL, NULL, '2021-07-24 14:25:35.057', 'USR-ADMIN', 'ADMIN', '1', NULL)
go
INSERT INTO sys_rule ([objid], [state], [name], [ruleset], [rulegroup], [title], [description], [salience], [effectivefrom], [effectiveto], [dtfiled], [user_objid], [user_name], [noloop], [_ukey]) VALUES ('RUL-3c38a261:17ad6957651:-7285', 'DEPLOYED', 'PENALTY_1992_TO_LESS_CY', 'rptbilling', 'PENALTY', 'PENALTY 1992 TO LESS CY', NULL, '50000', NULL, NULL, '2021-07-24 14:12:04.303', 'USR-ADMIN', 'ADMIN', '1', NULL)
go
INSERT INTO sys_rule ([objid], [state], [name], [ruleset], [rulegroup], [title], [description], [salience], [effectivefrom], [effectiveto], [dtfiled], [user_objid], [user_name], [noloop], [_ukey]) VALUES ('RUL-3c38a261:17ad6957651:-74ca', 'DEPLOYED', 'PENALTY_1991_AND_BELOW', 'rptbilling', 'PENALTY', 'PENALTY 1991 AND BELOW', NULL, '50000', NULL, NULL, '2021-07-24 14:10:37.870', 'USR-ADMIN', 'ADMIN', '1', NULL)
go
INSERT INTO sys_rule ([objid], [state], [name], [ruleset], [rulegroup], [title], [description], [salience], [effectivefrom], [effectiveto], [dtfiled], [user_objid], [user_name], [noloop], [_ukey]) VALUES ('RUL-3c38a261:17ad6957651:-763e', 'DEPLOYED', 'STAGGARD_AV_2003', 'rptledger', 'INIT', 'STAGGARD AV 2003', NULL, '50000', NULL, NULL, '2021-07-24 14:08:22.417', 'USR-ADMIN', 'ADMIN', '1', NULL)
go
INSERT INTO sys_rule ([objid], [state], [name], [ruleset], [rulegroup], [title], [description], [salience], [effectivefrom], [effectiveto], [dtfiled], [user_objid], [user_name], [noloop], [_ukey]) VALUES ('RUL-3c38a261:17ad6957651:-76a1', 'DEPLOYED', 'STAGGARD_AV_2002', 'rptledger', 'INIT', 'STAGGARD AV 2002', NULL, '50000', NULL, NULL, '2021-07-24 14:07:59.107', 'USR-ADMIN', 'ADMIN', '1', NULL)
go
INSERT INTO sys_rule ([objid], [state], [name], [ruleset], [rulegroup], [title], [description], [salience], [effectivefrom], [effectiveto], [dtfiled], [user_objid], [user_name], [noloop], [_ukey]) VALUES ('RUL-3c38a261:17ad6957651:-7c23', 'DEPLOYED', 'STAGGARD_AV_2001', 'rptledger', 'INIT', 'STAGGARD AV 2001', NULL, '50000', NULL, NULL, '2021-07-24 14:01:56.807', 'USR-ADMIN', 'ADMIN', '1', NULL)
go
INSERT INTO sys_rule ([objid], [state], [name], [ruleset], [rulegroup], [title], [description], [salience], [effectivefrom], [effectiveto], [dtfiled], [user_objid], [user_name], [noloop], [_ukey]) VALUES ('RUL-3e8edbea:156bc08656a:-5f05', 'DEPLOYED', 'RECALC_RPU_TOTAL_AV', 'landassessment', 'AFTER-SUMMARY', 'RECALC RPU TOTAL AV', NULL, '30000', NULL, NULL, '2016-08-24 19:03:36.000', 'USR-ADMIN', 'ADMIN', '1', '')
go
INSERT INTO sys_rule ([objid], [state], [name], [ruleset], [rulegroup], [title], [description], [salience], [effectivefrom], [effectiveto], [dtfiled], [user_objid], [user_name], [noloop], [_ukey]) VALUES ('RUL-43adaf20:179c6921191:-4d61', 'DEPLOYED', 'CALC_MV', 'landassessment', 'MARKETVALUE', 'CALC MV', NULL, '50000', NULL, NULL, '2021-06-01 16:31:15.000', 'USR-1b82c604:14cc29913bb:-7fec', 'ADMIN', '1', '')
go
INSERT INTO sys_rule ([objid], [state], [name], [ruleset], [rulegroup], [title], [description], [salience], [effectivefrom], [effectiveto], [dtfiled], [user_objid], [user_name], [noloop], [_ukey]) VALUES ('RUL-43adaf20:179c6921191:-4f03', 'DEPLOYED', 'BMV_ZERO_FOR_EXEMPT', 'landassessment', 'AFTER-BASEMARKETVALUE', 'BMV ZERO FOR EXEMPT', NULL, '50000', NULL, NULL, '2021-06-01 16:30:09.000', 'USR-1b82c604:14cc29913bb:-7fec', 'ADMIN', '1', '')
go
INSERT INTO sys_rule ([objid], [state], [name], [ruleset], [rulegroup], [title], [description], [salience], [effectivefrom], [effectiveto], [dtfiled], [user_objid], [user_name], [noloop], [_ukey]) VALUES ('RUL-43adaf20:179c6921191:-5152', 'DEPLOYED', 'CALC_BMV', 'landassessment', 'BASEMARKETVALUE', 'CALC BMV', NULL, '50000', NULL, NULL, '2021-06-01 16:29:03.000', 'USR-1b82c604:14cc29913bb:-7fec', 'ADMIN', '1', '')
go
INSERT INTO sys_rule ([objid], [state], [name], [ruleset], [rulegroup], [title], [description], [salience], [effectivefrom], [effectiveto], [dtfiled], [user_objid], [user_name], [noloop], [_ukey]) VALUES ('RUL-479f9644:17849e550ea:143', 'DEPLOYED', 'RECALC_RPU_TOTALAV', 'machassessment', 'AFTER-SUMMARY', 'RECALC RPU TOTALAV', NULL, '60000', NULL, NULL, '2021-03-19 20:02:18.000', 'USR-ADMIN', 'ADMIN', '1', '')
go
INSERT INTO sys_rule ([objid], [state], [name], [ruleset], [rulegroup], [title], [description], [salience], [effectivefrom], [effectiveto], [dtfiled], [user_objid], [user_name], [noloop], [_ukey]) VALUES ('RUL-5cc00751:179cb731d09:-6a11', 'DEPLOYED', 'DEFAULT_REQUIREMENTS', 'rptrequirement', 'REQUIREMENT', 'DEFAULT REQUIREMENTS', NULL, '50000', NULL, NULL, '2021-06-02 14:56:25.000', 'USR-1b82c604:14cc29913bb:-7fec', 'ADMIN', '1', '')
go
...
go
INSERT INTO sys_rule ([objid], [state], [name], [ruleset], [rulegroup], [title], [description], [salience], [effectivefrom], [effectiveto], [dtfiled], [user_objid], [user_name], [noloop], [_ukey]) VALUES ('RUL-762e9176:15d067a9c42:-5aa0', 'DEPLOYED', 'RECALC_RPU_TOTAL_AV', 'miscassessment', 'AFTER-SUMMARY', 'RECALC_RPU_TOTAL_AV', NULL, '60000', NULL, NULL, '2017-07-03 11:29:56.000', 'USR7e15465b:14a51353b1a:-7fb7', 'ADMIN', '1', '')
go
INSERT INTO sys_rule ([objid], [state], [name], [ruleset], [rulegroup], [title], [description], [salience], [effectivefrom], [effectiveto], [dtfiled], [user_objid], [user_name], [noloop], [_ukey]) VALUES ('RUL-762e9176:15d067a9c42:-5e26', 'DEPLOYED', 'CALC_TOTAL_ASSESSEMENT_AV', 'miscassessment', 'AFTER-SUMMARY', 'CALC_TOTAL_ASSESSEMENT_AV', NULL, '50000', NULL, NULL, '2017-07-03 11:28:17.000', 'USR7e15465b:14a51353b1a:-7fb7', 'ADMIN', '1', '')
go
INSERT INTO sys_rule ([objid], [state], [name], [ruleset], [rulegroup], [title], [description], [salience], [effectivefrom], [effectiveto], [dtfiled], [user_objid], [user_name], [noloop], [_ukey]) VALUES ('RUL-79a9a347:15cfcae84de:-55fd', 'DEPLOYED', 'CALC_TOTAL_ASSESSEMENT_AV', 'landassessment', 'AFTER-SUMMARY', 'CALC TOTAL ASSESSEMENT AV', NULL, '40000', NULL, NULL, '2017-07-01 14:32:46.000', 'USR7e15465b:14a51353b1a:-7fb7', 'ADMIN', '1', '')
go
...
go
INSERT INTO sys_rule ([objid], [state], [name], [ruleset], [rulegroup], [title], [description], [salience], [effectivefrom], [effectiveto], [dtfiled], [user_objid], [user_name], [noloop], [_ukey]) VALUES ('RUL-79a9a347:15cfcae84de:4f83', 'DEPLOYED', 'CALC_TOTAL_ASSESSEMENT_AV', 'planttreeassessment', 'AFTER-SUMMARY', 'CALC_TOTAL_ASSESSEMENT_AV', NULL, '50000', NULL, NULL, '2017-07-01 16:09:50.000', 'USR7e15465b:14a51353b1a:-7fb7', 'ADMIN', '1', '')
go
INSERT INTO sys_rule ([objid], [state], [name], [ruleset], [rulegroup], [title], [description], [salience], [effectivefrom], [effectiveto], [dtfiled], [user_objid], [user_name], [noloop], [_ukey]) VALUES ('RUL-79a9a347:15cfcae84de:549e', 'DEPLOYED', 'RECALC_TOTAL_AV', 'planttreeassessment', 'AFTER-SUMMARY', 'RECALC_TOTAL_AV', NULL, '60000', NULL, NULL, '2017-07-01 16:11:14.000', 'USR7e15465b:14a51353b1a:-7fb7', 'ADMIN', '1', '')
go
...
go
INSERT INTO sys_rule ([objid], [state], [name], [ruleset], [rulegroup], [title], [description], [salience], [effectivefrom], [effectiveto], [dtfiled], [user_objid], [user_name], [noloop], [_ukey]) VALUES ('RUL5ca73361:178b46b1030:-41a3', 'DEPLOYED', 'CALC_TOTAL_AV', 'machassessment', 'AFTER-SUMMARY', 'CALC TOTAL AV', NULL, '50000', NULL, NULL, '2021-04-09 11:00:44.000', 'USR6ebf7e79:156baa1135d:-7f9b', 'ADMIN', '1', '')
go
INSERT INTO sys_rule ([objid], [state], [name], [ruleset], [rulegroup], [title], [description], [salience], [effectivefrom], [effectiveto], [dtfiled], [user_objid], [user_name], [noloop], [_ukey]) VALUES ('RULec9d7ab:166235c2e16:-255e', 'DRAFT', 'BUILD_BILL_ITEMS', 'rptbilling', 'AFTER_SUMMARY', 'BUILD BILL ITEMS', NULL, '50000', NULL, NULL, '2018-09-29 00:27:14.000', 'USR-ADMIN', 'ADMIN', '1', '')
go
...
action.execute( "set-bill-expiry",_p0,drools);
	...
	')
go
INSERT INTO sys_rule_deployed ([objid], [ruletext]) VALUES ('RUL-3c38a261:17ad6957651:-33ca', '
package rptbilling.PDIC_RULE_01;
import rptbilling.*;
import java.util.*;
import com.rameses.rules.common.*;
...
rule "PDIC_RULE_01"
	...
	when
		...
		RL: rptis.landtax.facts.RPTLedgerFact (  objid matches "FRPTL00071954|FRPTL00077990|FRPTL00071952|FRPTL00080563" ) 
...
action.execute( "calc-interest",_p0,drools);
	...
	')
go
INSERT INTO sys_rule_deployed ([objid], [ruletext]) VALUES ('RUL-3c38a261:17ad6957651:-364e', '
...
action.execute( "create-tax-summary",_p0,drools);
	...
	')
go
INSERT INTO sys_rule_deployed ([objid], [ruletext]) VALUES ('RUL-3c38a261:17ad6957651:-3b26', '
package rptbilling.DISCOUNT_ADJUSTMENT_SP_ORD_2021;
import rptbilling.*;
import java.util.*;
import com.rameses.rules.common.*;
...
rule "DISCOUNT_ADJUSTMENT_SP_ORD_2021"
	...
	when
		...
		RL: rptis.landtax.facts.RPTLedgerFact (  lastyearpaid == 2021,LQTR:lastqtrpaid ) 
		
		RLI: rptis.landtax.facts.RPTLedgerItemFact (  year == 2021,fullypaid == true ,qtr >= CQTR ) 
	...
	Map _p0 = new HashMap();
_p0.put( "rptledgeritem", RLI );
_p0.put( "expr", (new ActionExpression("if ( LQTR == 1 && CQTR == 3 ) return TAX * 0.10; if ( LQTR == 2 && CQTR == 3 ) return TAX * 0.10; if ( LQTR == 3 && CQTR == 3 ) return TAX * 0.10; return 0;", bindings)) );
action.execute( "calc-discount",_p0,drools);
	...
	')
go
INSERT INTO sys_rule_deployed ([objid], [ruletext]) VALUES ('RUL-3c38a261:17ad6957651:-3bf9', '
package rptbilling.DISCOUNT_WITH_ARREAR_ZERO_ADJUSTMENT;
import rptbilling.*;
import java.util.*;
import com.rameses.rules.common.*;
...
rule "DISCOUNT_WITH_ARREAR_ZERO_ADJUSTMENT"
	agenda-group "AFTER_DISCOUNT"
	salience 50000
	no-loop
	when
		...
		RL: rptis.landtax.facts.RPTLedgerFact (  lastyearpaid < 2015 ) 
...
action.execute( "calc-discount",_p0,drools);
	...
	')
go
INSERT INTO sys_rule_deployed ([objid], [ruletext]) VALUES ('RUL-3c38a261:17ad6957651:-3fd6', '
package rptbilling.DISCOUNT_WITH_ARREAR_ZERO_ADJUSTMENT_2015;
import rptbilling.*;
import java.util.*;
import com.rameses.rules.common.*;
...
rule "DISCOUNT_WITH_ARREAR_ZERO_ADJUSTMENT_2015"
	agenda-group "AFTER_DISCOUNT"
	salience 50000
	no-loop
	when
		...
		RL: rptis.landtax.facts.RPTLedgerFact (  lastyearpaid == 2015,lastqtrpaid != 4 ) 
...
action.execute( "calc-discount",_p0,drools);
	...
	')
go
INSERT INTO sys_rule_deployed ([objid], [ruletext]) VALUES ('RUL-3c38a261:17ad6957651:-4180', '
package rptbilling.NO_DISCOUNT_ND;
import rptbilling.*;
import java.util.*;
import com.rameses.rules.common.*;
...
action.execute( "calc-discount",_p0,drools);
	...
	')
go
INSERT INTO sys_rule_deployed ([objid], [ruletext]) VALUES ('RUL-3c38a261:17ad6957651:-4513', '
package rptbilling.PENALTY_ADJUSTMENT_SP_ORD_2021;
import rptbilling.*;
import java.util.*;
import com.rameses.rules.common.*;
...
rule "PENALTY_ADJUSTMENT_SP_ORD_2021"
	...
	when
		...
		RLI: rptis.landtax.facts.RPTLedgerItemFact (  year == 2021,TAX:amtdue ) 
...
action.execute( "calc-interest",_p0,drools);
	...
	')
go
INSERT INTO sys_rule_deployed ([objid], [ruletext]) VALUES ('RUL-3c38a261:17ad6957651:-4699', '
package rptbilling.NO_PENALTY_BACKTAX;
import rptbilling.*;
import java.util.*;
import com.rameses.rules.common.*;
...
action.execute( "calc-interest",_p0,drools);
	...
	')
go
INSERT INTO sys_rule_deployed ([objid], [ruletext]) VALUES ('RUL-3c38a261:17ad6957651:-48b3', '
package rptbilling.NO_PENALTY_RECLASSED;
import rptbilling.*;
import java.util.*;
import com.rameses.rules.common.*;
...
rule "NO_PENALTY_RECLASSED"
	...
	when
		...
		RLI: rptis.landtax.facts.RPTLedgerItemFact (  year <= CY,reclassed == true  ) 
...
action.execute( "calc-interest",_p0,drools);
	...
	')
go
INSERT INTO sys_rule_deployed ([objid], [ruletext]) VALUES ('RUL-3c38a261:17ad6957651:-4b97', '
package rptbilling.NO_PENALTY_TAX_DIFFERENCE;
import rptbilling.*;
import java.util.*;
import com.rameses.rules.common.*;
...
rule "NO_PENALTY_TAX_DIFFERENCE"
	agenda-group "AFTER_PENALTY"
	salience 50000
	no-loop
	when
		...
		RLI: rptis.landtax.facts.RPTLedgerItemFact (  year <= CY,taxdifference == true  ) 
...
action.execute( "calc-interest",_p0,drools);
	...
	')
go
INSERT INTO sys_rule_deployed ([objid], [ruletext]) VALUES ('RUL-3c38a261:17ad6957651:-5551', '
package rptbilling.DISCOUNT_CURRENT_YEAR;
import rptbilling.*;
import java.util.*;
import com.rameses.rules.common.*;
...
rule "DISCOUNT_CURRENT_YEAR"
	...
	when
		...
		RL: rptis.landtax.facts.RPTLedgerFact (  LYR:lastyearpaid,LQTR:lastqtrpaid ) 
		
		RLI: rptis.landtax.facts.RPTLedgerItemFact (  year == CY,QTR:qtr >= CQTR,fullypaid == true  ) 
		
	then
		Map bindings = new HashMap();
		
		bindings.put("LYR", LYR );
	...
	Map _p0 = new HashMap();
_p0.put( "rptledgeritem", RLI );
_p0.put( "expr", (new ActionExpression("if ( LYR == CY && LQTR > CQTR - 1 ) return TAX * 0.10; if ( LYR == CY && LQTR == CQTR - 1 ) return TAX * 0.10; if ( LYR == CY - 1 && LQTR == 4 && CQTR == 1 ) return TAX * 0.10; return 0.00;", bindings)) );
action.execute( "calc-discount",_p0,drools);
	...
	')
go
INSERT INTO sys_rule_deployed ([objid], [ruletext]) VALUES ('RUL-3c38a261:17ad6957651:-5dbd', '
...
rule "PENALTY_CURRENT_YEAR"
	...
	when
		...
		RLI: rptis.landtax.facts.RPTLedgerItemFact (  year == CY,TAX:amtdue,NMONQ:monthsfromqtr,NMONJ:monthsfromjan,QTR:qtr ) 
	...
	then
		...
		bindings.put("NMONQ", NMONQ );
		
		bindings.put("NMONJ", NMONJ );
		
		bindings.put("QTR", QTR );
		
	Map _p0 = new HashMap();
_p0.put( "rptledgeritem", RLI );
_p0.put( "expr", (new ActionExpression("if ( LYR == CY - 1 ) return TAX * NMONJ * 0.02; if ( LYR == CY && CQTR < QTR && LQTR > 1 ) return TAX * NMONJ * 0.02; if ( LYR == CY && CQTR > QTR && LQTR > 1 ) return TAX * NMONQ * 0.02; return 0.0;", bindings)) );
action.execute( "calc-interest",_p0,drools);
	...
	')
go
INSERT INTO sys_rule_deployed ([objid], [ruletext]) VALUES ('RUL-3c38a261:17ad6957651:-7285', '
...
rule "PENALTY_1992_TO_LESS_CY"
	...
	when
		...
		RLI: rptis.landtax.facts.RPTLedgerItemFact (  year < CY,TAX:amtdue,NMON:monthsfromjan,year >= 1992 ) 
...
action.execute( "calc-interest",_p0,drools);
	...
	')
go
INSERT INTO sys_rule_deployed ([objid], [ruletext]) VALUES ('RUL-3c38a261:17ad6957651:-74ca', '
...
rule "PENALTY_1991_AND_BELOW"
	...
	when
		...
		RLI: rptis.landtax.facts.RPTLedgerItemFact (  year <= 1991,TAX:amtdue,NMON:monthsfromjan ) 
...
action.execute( "calc-interest",_p0,drools);
	...
	')
go
INSERT INTO sys_rule_deployed ([objid], [ruletext]) VALUES ('RUL-3c38a261:17ad6957651:-763e', '
package rptledger.STAGGARD_AV_2003;
import rptledger.*;
import java.util.*;
import com.rameses.rules.common.*;
...
rule "STAGGARD_AV_2003"
	...
	when
		...
		AVINFO: rptis.landtax.facts.AssessedValue (  year == 2003,LAV:av ) 
		
		PREVAVINFO: rptis.landtax.facts.AssessedValue (  year == 2000,PAV:av < LAV ) 
	...
	then
		...
		bindings.put("PAV", PAV );
		
		bindings.put("LAV", LAV );
		
		bindings.put("PREVAVINFO", PREVAVINFO );
		
	Map _p0 = new HashMap();
_p0.put( "avfact", AVINFO );
_p0.put( "expr", (new ActionExpression("(LAV - PAV) * 0.75 + PAV", bindings)) );
action.execute( "update-av",_p0,drools);
	...
	')
go
INSERT INTO sys_rule_deployed ([objid], [ruletext]) VALUES ('RUL-3c38a261:17ad6957651:-76a1', '
package rptledger.STAGGARD_AV_2002;
import rptledger.*;
import java.util.*;
import com.rameses.rules.common.*;
...
rule "STAGGARD_AV_2002"
	...
	when
		...
		AVINFO: rptis.landtax.facts.AssessedValue (  year == 2002,LAV:av ) 
	...
	Map _p0 = new HashMap();
_p0.put( "avfact", AVINFO );
_p0.put( "expr", (new ActionExpression("(LAV - PAV) * 0.50 + PAV", bindings)) );
action.execute( "update-av",_p0,drools);
	...
	')
go
INSERT INTO sys_rule_deployed ([objid], [ruletext]) VALUES ('RUL-3c38a261:17ad6957651:-7c23', '
package rptledger.STAGGARD_AV_2001;
import rptledger.*;
import java.util.*;
import com.rameses.rules.common.*;
...
rule "STAGGARD_AV_2001"
	...
	when
		...
		AVINFO: rptis.landtax.facts.AssessedValue (  year == 2001,LAV:av ) 
	...
	Map _p0 = new HashMap();
_p0.put( "avfact", AVINFO );
_p0.put( "expr", (new ActionExpression("(LAV - PAV) * 0.25 + PAV", bindings)) );
action.execute( "update-av",_p0,drools);
...
rule "TOTAL_PREVIOUS"
	...
	when
		...
		RLI: rptis.landtax.facts.RPTLedgerItemFact (  year >= 1992,year < CY ) 
...
rule "SPLIT_QUARTERLY_BILLED_ITEMS"
	...
	when
		...
		RLI: rptis.landtax.facts.RPTLedgerItemFact (  qtrly == false  ) 
...
rule "DISCOUNT_ADVANCE"
	...
	Map _p0 = new HashMap();
_p0.put( "rptledgeritem", RLI );
_p0.put( "expr", (new ActionExpression("@ROUND(TAX * 0.15)", bindings)) );
action.execute( "calc-discount",_p0,drools);
...
go
INSERT INTO sys_rule_condition ([objid], [parentid], [fact_name], [fact_objid], [varname], [pos], [ruletext], [displaytext], [dynamic_datatype], [dynamic_key], [dynamic_value], [notexist]) VALUES ('RC-5ca24d41:17ad69901c6:-7cc5', 'RUL-3c38a261:17ad6957651:-364e', 'rptis.landtax.facts.RPTLedgerItemFact', 'rptis.landtax.facts.RPTLedgerItemFact', 'RLI', '1', NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition ([objid], [parentid], [fact_name], [fact_objid], [varname], [pos], [ruletext], [displaytext], [dynamic_datatype], [dynamic_key], [dynamic_value], [notexist]) VALUES ('RC-5ca24d41:17ad69901c6:-7cdc', 'RUL-3c38a261:17ad6957651:-3b26', 'rptis.landtax.facts.RPTLedgerItemFact', 'rptis.landtax.facts.RPTLedgerItemFact', 'RLI', '2', NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition ([objid], [parentid], [fact_name], [fact_objid], [varname], [pos], [ruletext], [displaytext], [dynamic_datatype], [dynamic_key], [dynamic_value], [notexist]) VALUES ('RC-5ca24d41:17ad69901c6:-7cde', 'RUL-3c38a261:17ad6957651:-3b26', 'rptis.landtax.facts.RPTLedgerFact', 'rptis.landtax.facts.RPTLedgerFact', 'RL', '1', NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition ([objid], [parentid], [fact_name], [fact_objid], [varname], [pos], [ruletext], [displaytext], [dynamic_datatype], [dynamic_key], [dynamic_value], [notexist]) VALUES ('RC-5ca24d41:17ad69901c6:-7ce0', 'RUL-3c38a261:17ad6957651:-3b26', 'CurrentDate', 'CurrentDate', NULL, '0', NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition ([objid], [parentid], [fact_name], [fact_objid], [varname], [pos], [ruletext], [displaytext], [dynamic_datatype], [dynamic_key], [dynamic_value], [notexist]) VALUES ('RC-5ca24d41:17ad69901c6:-7ce9', 'RUL-3c38a261:17ad6957651:-3bf9', 'CurrentDate', 'CurrentDate', NULL, '0', NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition ([objid], [parentid], [fact_name], [fact_objid], [varname], [pos], [ruletext], [displaytext], [dynamic_datatype], [dynamic_key], [dynamic_value], [notexist]) VALUES ('RC-5ca24d41:17ad69901c6:-7cec', 'RUL-3c38a261:17ad6957651:-3bf9', 'rptis.landtax.facts.RPTLedgerFact', 'rptis.landtax.facts.RPTLedgerFact', 'RL', '1', NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition ([objid], [parentid], [fact_name], [fact_objid], [varname], [pos], [ruletext], [displaytext], [dynamic_datatype], [dynamic_key], [dynamic_value], [notexist]) VALUES ('RC-5ca24d41:17ad69901c6:-7cee', 'RUL-3c38a261:17ad6957651:-3bf9', 'rptis.landtax.facts.RPTLedgerItemFact', 'rptis.landtax.facts.RPTLedgerItemFact', 'RLI', '2', NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition ([objid], [parentid], [fact_name], [fact_objid], [varname], [pos], [ruletext], [displaytext], [dynamic_datatype], [dynamic_key], [dynamic_value], [notexist]) VALUES ('RC-5ca24d41:17ad69901c6:-7d10', 'RUL-3c38a261:17ad6957651:-4699', 'rptis.landtax.facts.RPTLedgerItemFact', 'rptis.landtax.facts.RPTLedgerItemFact', 'RLI', '1', NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition ([objid], [parentid], [fact_name], [fact_objid], [varname], [pos], [ruletext], [displaytext], [dynamic_datatype], [dynamic_key], [dynamic_value], [notexist]) VALUES ('RC-5ca24d41:17ad69901c6:-7d12', 'RUL-3c38a261:17ad6957651:-4699', 'CurrentDate', 'CurrentDate', NULL, '0', NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition ([objid], [parentid], [fact_name], [fact_objid], [varname], [pos], [ruletext], [displaytext], [dynamic_datatype], [dynamic_key], [dynamic_value], [notexist]) VALUES ('RC-5ca24d41:17ad69901c6:-7d1b', 'RUL-3c38a261:17ad6957651:-48b3', 'CurrentDate', 'CurrentDate', NULL, '0', NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition ([objid], [parentid], [fact_name], [fact_objid], [varname], [pos], [ruletext], [displaytext], [dynamic_datatype], [dynamic_key], [dynamic_value], [notexist]) VALUES ('RC-5ca24d41:17ad69901c6:-7d1e', 'RUL-3c38a261:17ad6957651:-48b3', 'rptis.landtax.facts.RPTLedgerItemFact', 'rptis.landtax.facts.RPTLedgerItemFact', 'RLI', '1', NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition ([objid], [parentid], [fact_name], [fact_objid], [varname], [pos], [ruletext], [displaytext], [dynamic_datatype], [dynamic_key], [dynamic_value], [notexist]) VALUES ('RC-5ca24d41:17ad69901c6:-7d8b', 'RUL-3c38a261:17ad6957651:-7285', 'CurrentDate', 'CurrentDate', NULL, '0', NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition ([objid], [parentid], [fact_name], [fact_objid], [varname], [pos], [ruletext], [displaytext], [dynamic_datatype], [dynamic_key], [dynamic_value], [notexist]) VALUES ('RC-5ca24d41:17ad69901c6:-7d8f', 'RUL-3c38a261:17ad6957651:-7285', 'rptis.landtax.facts.RPTLedgerItemFact', 'rptis.landtax.facts.RPTLedgerItemFact', 'RLI', '1', NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition ([objid], [parentid], [fact_name], [fact_objid], [varname], [pos], [ruletext], [displaytext], [dynamic_datatype], [dynamic_key], [dynamic_value], [notexist]) VALUES ('RC-5ca24d41:17ad69901c6:-7d9c', 'RUL-3c38a261:17ad6957651:-74ca', 'rptis.landtax.facts.RPTLedgerItemFact', 'rptis.landtax.facts.RPTLedgerItemFact', 'RLI', '1', NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition ([objid], [parentid], [fact_name], [fact_objid], [varname], [pos], [ruletext], [displaytext], [dynamic_datatype], [dynamic_key], [dynamic_value], [notexist]) VALUES ('RC-5ca24d41:17ad69901c6:-7dae', 'RUL-3c38a261:17ad6957651:-763e', 'rptis.landtax.facts.AssessedValue', 'rptis.landtax.facts.AssessedValue', 'PREVAVINFO', '1', NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition ([objid], [parentid], [fact_name], [fact_objid], [varname], [pos], [ruletext], [displaytext], [dynamic_datatype], [dynamic_key], [dynamic_value], [notexist]) VALUES ('RC-5ca24d41:17ad69901c6:-7db1', 'RUL-3c38a261:17ad6957651:-763e', 'rptis.landtax.facts.AssessedValue', 'rptis.landtax.facts.AssessedValue', 'AVINFO', '0', NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition ([objid], [parentid], [fact_name], [fact_objid], [varname], [pos], [ruletext], [displaytext], [dynamic_datatype], [dynamic_key], [dynamic_value], [notexist]) VALUES ('RC-5ca24d41:17ad69901c6:-7db7', 'RUL-3c38a261:17ad6957651:-76a1', 'rptis.landtax.facts.AssessedValue', 'rptis.landtax.facts.AssessedValue', 'AVINFO', '0', NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition ([objid], [parentid], [fact_name], [fact_objid], [varname], [pos], [ruletext], [displaytext], [dynamic_datatype], [dynamic_key], [dynamic_value], [notexist]) VALUES ('RC-5ca24d41:17ad69901c6:-7dba', 'RUL-3c38a261:17ad6957651:-76a1', 'rptis.landtax.facts.AssessedValue', 'rptis.landtax.facts.AssessedValue', 'PREVAVINFO', '1', NULL, NULL, NULL, NULL, NULL, '0')
go
...
go
INSERT INTO sys_rule_condition ([objid], [parentid], [fact_name], [fact_objid], [varname], [pos], [ruletext], [displaytext], [dynamic_datatype], [dynamic_key], [dynamic_value], [notexist]) VALUES ('RCOND-3c38a261:17ad6957651:-31bf', 'RUL-3c38a261:17ad6957651:-33ca', 'rptis.landtax.facts.RPTLedgerItemFact', 'rptis.landtax.facts.RPTLedgerItemFact', 'RLI', '2', NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition ([objid], [parentid], [fact_name], [fact_objid], [varname], [pos], [ruletext], [displaytext], [dynamic_datatype], [dynamic_key], [dynamic_value], [notexist]) VALUES ('RCOND-3c38a261:17ad6957651:-32d7', 'RUL-3c38a261:17ad6957651:-33ca', 'rptis.landtax.facts.RPTLedgerFact', 'rptis.landtax.facts.RPTLedgerFact', 'RL', '1', NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition ([objid], [parentid], [fact_name], [fact_objid], [varname], [pos], [ruletext], [displaytext], [dynamic_datatype], [dynamic_key], [dynamic_value], [notexist]) VALUES ('RCOND-3c38a261:17ad6957651:-3376', 'RUL-3c38a261:17ad6957651:-33ca', 'CurrentDate', 'CurrentDate', NULL, '0', NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition ([objid], [parentid], [fact_name], [fact_objid], [varname], [pos], [ruletext], [displaytext], [dynamic_datatype], [dynamic_key], [dynamic_value], [notexist]) VALUES ('RCOND-3c38a261:17ad6957651:-3dc0', 'RUL-3c38a261:17ad6957651:-3fd6', 'rptis.landtax.facts.RPTLedgerItemFact', 'rptis.landtax.facts.RPTLedgerItemFact', 'RLI', '2', NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition ([objid], [parentid], [fact_name], [fact_objid], [varname], [pos], [ruletext], [displaytext], [dynamic_datatype], [dynamic_key], [dynamic_value], [notexist]) VALUES ('RCOND-3c38a261:17ad6957651:-3ee7', 'RUL-3c38a261:17ad6957651:-3fd6', 'rptis.landtax.facts.RPTLedgerFact', 'rptis.landtax.facts.RPTLedgerFact', 'RL', '1', NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition ([objid], [parentid], [fact_name], [fact_objid], [varname], [pos], [ruletext], [displaytext], [dynamic_datatype], [dynamic_key], [dynamic_value], [notexist]) VALUES ('RCOND-3c38a261:17ad6957651:-3f84', 'RUL-3c38a261:17ad6957651:-3fd6', 'CurrentDate', 'CurrentDate', NULL, '0', NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition ([objid], [parentid], [fact_name], [fact_objid], [varname], [pos], [ruletext], [displaytext], [dynamic_datatype], [dynamic_key], [dynamic_value], [notexist]) VALUES ('RCOND-3c38a261:17ad6957651:-411a', 'RUL-3c38a261:17ad6957651:-4180', 'rptis.landtax.facts.RPTLedgerItemFact', 'rptis.landtax.facts.RPTLedgerItemFact', 'RLI', '0', NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition ([objid], [parentid], [fact_name], [fact_objid], [varname], [pos], [ruletext], [displaytext], [dynamic_datatype], [dynamic_key], [dynamic_value], [notexist]) VALUES ('RCOND-3c38a261:17ad6957651:-4402', 'RUL-3c38a261:17ad6957651:-4513', 'rptis.landtax.facts.RPTLedgerItemFact', 'rptis.landtax.facts.RPTLedgerItemFact', 'RLI', '1', NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition ([objid], [parentid], [fact_name], [fact_objid], [varname], [pos], [ruletext], [displaytext], [dynamic_datatype], [dynamic_key], [dynamic_value], [notexist]) VALUES ('RCOND-3c38a261:17ad6957651:-4a94', 'RUL-3c38a261:17ad6957651:-4b97', 'rptis.landtax.facts.RPTLedgerItemFact', 'rptis.landtax.facts.RPTLedgerItemFact', 'RLI', '1', NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition ([objid], [parentid], [fact_name], [fact_objid], [varname], [pos], [ruletext], [displaytext], [dynamic_datatype], [dynamic_key], [dynamic_value], [notexist]) VALUES ('RCOND-3c38a261:17ad6957651:-4b45', 'RUL-3c38a261:17ad6957651:-4b97', 'CurrentDate', 'CurrentDate', NULL, '0', NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition ([objid], [parentid], [fact_name], [fact_objid], [varname], [pos], [ruletext], [displaytext], [dynamic_datatype], [dynamic_key], [dynamic_value], [notexist]) VALUES ('RCOND-3c38a261:17ad6957651:-4ce2', 'RULec9d7ab:166235c2e16:-4197', 'rptis.landtax.facts.RPTLedgerFact', 'rptis.landtax.facts.RPTLedgerFact', 'RL', '2', NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition ([objid], [parentid], [fact_name], [fact_objid], [varname], [pos], [ruletext], [displaytext], [dynamic_datatype], [dynamic_key], [dynamic_value], [notexist]) VALUES ('RCOND-3c38a261:17ad6957651:-52e1', 'RUL-3c38a261:17ad6957651:-5551', 'rptis.landtax.facts.RPTLedgerItemFact', 'rptis.landtax.facts.RPTLedgerItemFact', 'RLI', '2', NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition ([objid], [parentid], [fact_name], [fact_objid], [varname], [pos], [ruletext], [displaytext], [dynamic_datatype], [dynamic_key], [dynamic_value], [notexist]) VALUES ('RCOND-3c38a261:17ad6957651:-540a', 'RUL-3c38a261:17ad6957651:-5551', 'rptis.landtax.facts.RPTLedgerFact', 'rptis.landtax.facts.RPTLedgerFact', 'RL', '1', NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition ([objid], [parentid], [fact_name], [fact_objid], [varname], [pos], [ruletext], [displaytext], [dynamic_datatype], [dynamic_key], [dynamic_value], [notexist]) VALUES ('RCOND-3c38a261:17ad6957651:-54ff', 'RUL-3c38a261:17ad6957651:-5551', 'CurrentDate', 'CurrentDate', NULL, '0', NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition ([objid], [parentid], [fact_name], [fact_objid], [varname], [pos], [ruletext], [displaytext], [dynamic_datatype], [dynamic_key], [dynamic_value], [notexist]) VALUES ('RCOND-3c38a261:17ad6957651:-5ad2', 'RUL-3c38a261:17ad6957651:-5dbd', 'rptis.landtax.facts.RPTLedgerItemFact', 'rptis.landtax.facts.RPTLedgerItemFact', 'RLI', '2', NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition ([objid], [parentid], [fact_name], [fact_objid], [varname], [pos], [ruletext], [displaytext], [dynamic_datatype], [dynamic_key], [dynamic_value], [notexist]) VALUES ('RCOND-3c38a261:17ad6957651:-5c6a', 'RUL-3c38a261:17ad6957651:-5dbd', 'rptis.landtax.facts.RPTLedgerFact', 'rptis.landtax.facts.RPTLedgerFact', 'RL', '1', NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition ([objid], [parentid], [fact_name], [fact_objid], [varname], [pos], [ruletext], [displaytext], [dynamic_datatype], [dynamic_key], [dynamic_value], [notexist]) VALUES ('RCOND-3c38a261:17ad6957651:-5d6b', 'RUL-3c38a261:17ad6957651:-5dbd', 'CurrentDate', 'CurrentDate', NULL, '0', NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition ([objid], [parentid], [fact_name], [fact_objid], [varname], [pos], [ruletext], [displaytext], [dynamic_datatype], [dynamic_key], [dynamic_value], [notexist]) VALUES ('RCOND-3c38a261:17ad6957651:-78b7', 'RUL-3c38a261:17ad6957651:-7c23', 'rptis.landtax.facts.AssessedValue', 'rptis.landtax.facts.AssessedValue', 'PREVAVINFO', '1', NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition ([objid], [parentid], [fact_name], [fact_objid], [varname], [pos], [ruletext], [displaytext], [dynamic_datatype], [dynamic_key], [dynamic_value], [notexist]) VALUES ('RCOND-3c38a261:17ad6957651:-7903', 'RUL-3c38a261:17ad6957651:-7c23', 'rptis.landtax.facts.AssessedValue', 'rptis.landtax.facts.AssessedValue', 'AVINFO', '0', NULL, NULL, NULL, NULL, NULL, '0')
go
...
go
INSERT INTO sys_rule_condition ([objid], [parentid], [fact_name], [fact_objid], [varname], [pos], [ruletext], [displaytext], [dynamic_datatype], [dynamic_key], [dynamic_value], [notexist]) VALUES ('RCOND-5cc00751:179cb731d09:-69e4', 'RUL-5cc00751:179cb731d09:-6a11', 'RPTTxnInfoFact', 'RPTTxnInfoFact', NULL, '0', NULL, NULL, NULL, NULL, NULL, '0')
go
...
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RC-5ca24d41:17ad69901c6:-7cc5', 'RC-5ca24d41:17ad69901c6:-7cc5', 'RUL-3c38a261:17ad6957651:-364e', 'RLI', 'rptis.landtax.facts.RPTLedgerItemFact', '1')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RC-5ca24d41:17ad69901c6:-7cdc', 'RC-5ca24d41:17ad69901c6:-7cdc', 'RUL-3c38a261:17ad6957651:-3b26', 'RLI', 'rptis.landtax.facts.RPTLedgerItemFact', '2')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RC-5ca24d41:17ad69901c6:-7cde', 'RC-5ca24d41:17ad69901c6:-7cde', 'RUL-3c38a261:17ad6957651:-3b26', 'RL', 'rptis.landtax.facts.RPTLedgerFact', '1')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RC-5ca24d41:17ad69901c6:-7cec', 'RC-5ca24d41:17ad69901c6:-7cec', 'RUL-3c38a261:17ad6957651:-3bf9', 'RL', 'rptis.landtax.facts.RPTLedgerFact', '1')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RC-5ca24d41:17ad69901c6:-7cee', 'RC-5ca24d41:17ad69901c6:-7cee', 'RUL-3c38a261:17ad6957651:-3bf9', 'RLI', 'rptis.landtax.facts.RPTLedgerItemFact', '2')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RC-5ca24d41:17ad69901c6:-7d10', 'RC-5ca24d41:17ad69901c6:-7d10', 'RUL-3c38a261:17ad6957651:-4699', 'RLI', 'rptis.landtax.facts.RPTLedgerItemFact', '1')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RC-5ca24d41:17ad69901c6:-7d1e', 'RC-5ca24d41:17ad69901c6:-7d1e', 'RUL-3c38a261:17ad6957651:-48b3', 'RLI', 'rptis.landtax.facts.RPTLedgerItemFact', '1')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RC-5ca24d41:17ad69901c6:-7d8f', 'RC-5ca24d41:17ad69901c6:-7d8f', 'RUL-3c38a261:17ad6957651:-7285', 'RLI', 'rptis.landtax.facts.RPTLedgerItemFact', '1')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RC-5ca24d41:17ad69901c6:-7d9c', 'RC-5ca24d41:17ad69901c6:-7d9c', 'RUL-3c38a261:17ad6957651:-74ca', 'RLI', 'rptis.landtax.facts.RPTLedgerItemFact', '1')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RC-5ca24d41:17ad69901c6:-7dae', 'RC-5ca24d41:17ad69901c6:-7dae', 'RUL-3c38a261:17ad6957651:-763e', 'PREVAVINFO', 'rptis.landtax.facts.AssessedValue', '1')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RC-5ca24d41:17ad69901c6:-7db1', 'RC-5ca24d41:17ad69901c6:-7db1', 'RUL-3c38a261:17ad6957651:-763e', 'AVINFO', 'rptis.landtax.facts.AssessedValue', '0')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RC-5ca24d41:17ad69901c6:-7db7', 'RC-5ca24d41:17ad69901c6:-7db7', 'RUL-3c38a261:17ad6957651:-76a1', 'AVINFO', 'rptis.landtax.facts.AssessedValue', '0')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RC-5ca24d41:17ad69901c6:-7dba', 'RC-5ca24d41:17ad69901c6:-7dba', 'RUL-3c38a261:17ad6957651:-76a1', 'PREVAVINFO', 'rptis.landtax.facts.AssessedValue', '1')
go
...
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCC-5ca24d41:17ad69901c6:-7cdf', 'RC-5ca24d41:17ad69901c6:-7ce0', 'RUL-3c38a261:17ad6957651:-3b26', 'CY', 'integer', '0')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCC-5ca24d41:17ad69901c6:-7ce8', 'RC-5ca24d41:17ad69901c6:-7ce9', 'RUL-3c38a261:17ad6957651:-3bf9', 'CY', 'integer', '0')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCC-5ca24d41:17ad69901c6:-7d11', 'RC-5ca24d41:17ad69901c6:-7d12', 'RUL-3c38a261:17ad6957651:-4699', 'CY', 'integer', '0')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCC-5ca24d41:17ad69901c6:-7d1a', 'RC-5ca24d41:17ad69901c6:-7d1b', 'RUL-3c38a261:17ad6957651:-48b3', 'CY', 'integer', '0')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCC-5ca24d41:17ad69901c6:-7d8a', 'RC-5ca24d41:17ad69901c6:-7d8b', 'RUL-3c38a261:17ad6957651:-7285', 'CY', 'integer', '0')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCC-5ca24d41:17ad69901c6:-7d8d', 'RC-5ca24d41:17ad69901c6:-7d8f', 'RUL-3c38a261:17ad6957651:-7285', 'TAX', 'decimal', '1')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCC-5ca24d41:17ad69901c6:-7d8e', 'RC-5ca24d41:17ad69901c6:-7d8f', 'RUL-3c38a261:17ad6957651:-7285', 'NMON', 'integer', '2')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCC-5ca24d41:17ad69901c6:-7d9a', 'RC-5ca24d41:17ad69901c6:-7d9c', 'RUL-3c38a261:17ad6957651:-74ca', 'TAX', 'decimal', '1')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCC-5ca24d41:17ad69901c6:-7dac', 'RC-5ca24d41:17ad69901c6:-7dae', 'RUL-3c38a261:17ad6957651:-763e', 'PAV', 'decimal', '1')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCC-5ca24d41:17ad69901c6:-7daf', 'RC-5ca24d41:17ad69901c6:-7db1', 'RUL-3c38a261:17ad6957651:-763e', 'LAV', 'decimal', '1')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCC-5ca24d41:17ad69901c6:-7db6', 'RC-5ca24d41:17ad69901c6:-7db7', 'RUL-3c38a261:17ad6957651:-76a1', 'LAV', 'decimal', '1')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCC-5ca24d41:17ad69901c6:-7db9', 'RC-5ca24d41:17ad69901c6:-7dba', 'RUL-3c38a261:17ad6957651:-76a1', 'PAV', 'decimal', '1')
go
...
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCOND-3c38a261:17ad6957651:-31bf', 'RCOND-3c38a261:17ad6957651:-31bf', 'RUL-3c38a261:17ad6957651:-33ca', 'RLI', 'rptis.landtax.facts.RPTLedgerItemFact', '2')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCOND-3c38a261:17ad6957651:-32d7', 'RCOND-3c38a261:17ad6957651:-32d7', 'RUL-3c38a261:17ad6957651:-33ca', 'RL', 'rptis.landtax.facts.RPTLedgerFact', '1')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCOND-3c38a261:17ad6957651:-3dc0', 'RCOND-3c38a261:17ad6957651:-3dc0', 'RUL-3c38a261:17ad6957651:-3fd6', 'RLI', 'rptis.landtax.facts.RPTLedgerItemFact', '2')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCOND-3c38a261:17ad6957651:-3ee7', 'RCOND-3c38a261:17ad6957651:-3ee7', 'RUL-3c38a261:17ad6957651:-3fd6', 'RL', 'rptis.landtax.facts.RPTLedgerFact', '1')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCOND-3c38a261:17ad6957651:-411a', 'RCOND-3c38a261:17ad6957651:-411a', 'RUL-3c38a261:17ad6957651:-4180', 'RLI', 'rptis.landtax.facts.RPTLedgerItemFact', '0')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCOND-3c38a261:17ad6957651:-4402', 'RCOND-3c38a261:17ad6957651:-4402', 'RUL-3c38a261:17ad6957651:-4513', 'RLI', 'rptis.landtax.facts.RPTLedgerItemFact', '1')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCOND-3c38a261:17ad6957651:-4a94', 'RCOND-3c38a261:17ad6957651:-4a94', 'RUL-3c38a261:17ad6957651:-4b97', 'RLI', 'rptis.landtax.facts.RPTLedgerItemFact', '1')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCOND-3c38a261:17ad6957651:-4ce2', 'RCOND-3c38a261:17ad6957651:-4ce2', 'RULec9d7ab:166235c2e16:-4197', 'RL', 'rptis.landtax.facts.RPTLedgerFact', '2')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCOND-3c38a261:17ad6957651:-52e1', 'RCOND-3c38a261:17ad6957651:-52e1', 'RUL-3c38a261:17ad6957651:-5551', 'RLI', 'rptis.landtax.facts.RPTLedgerItemFact', '2')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCOND-3c38a261:17ad6957651:-540a', 'RCOND-3c38a261:17ad6957651:-540a', 'RUL-3c38a261:17ad6957651:-5551', 'RL', 'rptis.landtax.facts.RPTLedgerFact', '1')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCOND-3c38a261:17ad6957651:-5ad2', 'RCOND-3c38a261:17ad6957651:-5ad2', 'RUL-3c38a261:17ad6957651:-5dbd', 'RLI', 'rptis.landtax.facts.RPTLedgerItemFact', '2')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCOND-3c38a261:17ad6957651:-5c6a', 'RCOND-3c38a261:17ad6957651:-5c6a', 'RUL-3c38a261:17ad6957651:-5dbd', 'RL', 'rptis.landtax.facts.RPTLedgerFact', '1')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCOND-3c38a261:17ad6957651:-78b7', 'RCOND-3c38a261:17ad6957651:-78b7', 'RUL-3c38a261:17ad6957651:-7c23', 'PREVAVINFO', 'rptis.landtax.facts.AssessedValue', '1')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCOND-3c38a261:17ad6957651:-7903', 'RCOND-3c38a261:17ad6957651:-7903', 'RUL-3c38a261:17ad6957651:-7c23', 'AVINFO', 'rptis.landtax.facts.AssessedValue', '0')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCOND-43adaf20:179c6921191:-4d1d', 'RCOND-43adaf20:179c6921191:-4d1d', 'RUL-43adaf20:179c6921191:-4d61', 'LA', 'rptis.land.facts.LandDetail', '0')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCOND-43adaf20:179c6921191:-4ebf', 'RCOND-43adaf20:179c6921191:-4ebf', 'RUL-43adaf20:179c6921191:-4f03', 'LA', 'rptis.land.facts.LandDetail', '0')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCOND-43adaf20:179c6921191:-510e', 'RCOND-43adaf20:179c6921191:-510e', 'RUL-43adaf20:179c6921191:-5152', 'LA', 'rptis.land.facts.LandDetail', '0')
go
...
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-335a', 'RCOND-3c38a261:17ad6957651:-3376', 'RUL-3c38a261:17ad6957651:-33ca', 'CY', 'integer', '0')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-39fc', 'RC-5ca24d41:17ad69901c6:-7cde', 'RUL-3c38a261:17ad6957651:-3b26', 'LQTR', 'integer', '1')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-3ad1', 'RC-5ca24d41:17ad69901c6:-7ce0', 'RUL-3c38a261:17ad6957651:-3b26', 'CQTR', 'integer', '1')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-3f68', 'RCOND-3c38a261:17ad6957651:-3f84', 'RUL-3c38a261:17ad6957651:-3fd6', 'CY', 'integer', '0')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-430b', 'RCOND-3c38a261:17ad6957651:-4402', 'RUL-3c38a261:17ad6957651:-4513', 'TAX', 'decimal', '1')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-4b29', 'RCOND-3c38a261:17ad6957651:-4b45', 'RUL-3c38a261:17ad6957651:-4b97', 'CY', 'integer', '0')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-5213', 'RCOND-3c38a261:17ad6957651:-52e1', 'RUL-3c38a261:17ad6957651:-5551', 'QTR', 'integer', '1')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-5365', 'RCOND-3c38a261:17ad6957651:-540a', 'RUL-3c38a261:17ad6957651:-5551', 'LQTR', 'integer', '1')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-53c4', 'RCOND-3c38a261:17ad6957651:-540a', 'RUL-3c38a261:17ad6957651:-5551', 'LYR', 'integer', '0')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-54a8', 'RCOND-3c38a261:17ad6957651:-54ff', 'RUL-3c38a261:17ad6957651:-5551', 'CQTR', 'integer', '1')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-54e3', 'RCOND-3c38a261:17ad6957651:-54ff', 'RUL-3c38a261:17ad6957651:-5551', 'CY', 'integer', '0')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-5724', 'RCOND-3c38a261:17ad6957651:-5ad2', 'RUL-3c38a261:17ad6957651:-5dbd', 'QTR', 'integer', '4')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-5840', 'RCOND-3c38a261:17ad6957651:-5ad2', 'RUL-3c38a261:17ad6957651:-5dbd', 'NMONJ', 'integer', '3')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-591e', 'RCOND-3c38a261:17ad6957651:-5ad2', 'RUL-3c38a261:17ad6957651:-5dbd', 'NMONQ', 'integer', '2')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-59dc', 'RCOND-3c38a261:17ad6957651:-5ad2', 'RUL-3c38a261:17ad6957651:-5dbd', 'TAX', 'decimal', '1')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-5b58', 'RCOND-3c38a261:17ad6957651:-5c6a', 'RUL-3c38a261:17ad6957651:-5dbd', 'LQTR', 'integer', '1')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-5bc6', 'RCOND-3c38a261:17ad6957651:-5c6a', 'RUL-3c38a261:17ad6957651:-5dbd', 'LYR', 'integer', '0')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-5d14', 'RCOND-3c38a261:17ad6957651:-5d6b', 'RUL-3c38a261:17ad6957651:-5dbd', 'CQTR', 'integer', '1')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-5d4f', 'RCOND-3c38a261:17ad6957651:-5d6b', 'RUL-3c38a261:17ad6957651:-5dbd', 'CY', 'integer', '0')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-73bb', 'RC-5ca24d41:17ad69901c6:-7d9c', 'RUL-3c38a261:17ad6957651:-74ca', 'NMON', 'integer', '2')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-78b5', 'RCOND-3c38a261:17ad6957651:-78b7', 'RUL-3c38a261:17ad6957651:-7c23', 'PAV', 'decimal', '1')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-7901', 'RCOND-3c38a261:17ad6957651:-7903', 'RUL-3c38a261:17ad6957651:-7c23', 'LAV', 'decimal', '1')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCONST-43adaf20:179c6921191:-4c4d', 'RCOND-43adaf20:179c6921191:-4d1d', 'RUL-43adaf20:179c6921191:-4d61', 'ADJ', 'decimal', '1')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCONST-43adaf20:179c6921191:-4cc1', 'RCOND-43adaf20:179c6921191:-4d1d', 'RUL-43adaf20:179c6921191:-4d61', 'BMV', 'decimal', '0')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCONST-43adaf20:179c6921191:-5051', 'RCOND-43adaf20:179c6921191:-510e', 'RUL-43adaf20:179c6921191:-5152', 'UV', 'decimal', '1')
go
INSERT INTO sys_rule_condition_var ([objid], [parentid], [ruleid], [varname], [datatype], [pos]) VALUES ('RCONST-43adaf20:179c6921191:-50bf', 'RCOND-43adaf20:179c6921191:-510e', 'RUL-43adaf20:179c6921191:-5152', 'AREA', 'decimal', '0')
go
...
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCC-5ca24d41:17ad69901c6:-7cc4', 'RC-5ca24d41:17ad69901c6:-7cc5', 'rptis.landtax.facts.RPTLedgerItemFact.year', 'year', NULL, 'less than or equal to', '<=', '0', NULL, NULL, NULL, '1991', NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCC-5ca24d41:17ad69901c6:-7cdb', 'RC-5ca24d41:17ad69901c6:-7cdc', 'rptis.landtax.facts.RPTLedgerItemFact.year', 'year', NULL, 'equal to', '==', '0', NULL, NULL, NULL, '2021', NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCC-5ca24d41:17ad69901c6:-7cdd', 'RC-5ca24d41:17ad69901c6:-7cde', 'rptis.landtax.facts.RPTLedgerFact.lastyearpaid', 'lastyearpaid', NULL, 'equal to', '==', NULL, NULL, NULL, NULL, '2021', NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCC-5ca24d41:17ad69901c6:-7cdf', 'RC-5ca24d41:17ad69901c6:-7ce0', 'CurrentDate.year', 'year', 'CY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCC-5ca24d41:17ad69901c6:-7ce8', 'RC-5ca24d41:17ad69901c6:-7ce9', 'CurrentDate.year', 'year', 'CY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCC-5ca24d41:17ad69901c6:-7cea', 'RC-5ca24d41:17ad69901c6:-7cec', 'rptis.landtax.facts.RPTLedgerFact.lastyearpaid', 'lastyearpaid', NULL, 'less than', '<', NULL, NULL, NULL, NULL, '2015', NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCC-5ca24d41:17ad69901c6:-7ced', 'RC-5ca24d41:17ad69901c6:-7cee', 'rptis.landtax.facts.RPTLedgerItemFact.year', 'year', NULL, 'equal to', '==', '1', NULL, 'CY', NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCC-5ca24d41:17ad69901c6:-7d0f', 'RC-5ca24d41:17ad69901c6:-7d10', 'rptis.landtax.facts.RPTLedgerItemFact.year', 'year', NULL, 'less than or equal to', '<=', '1', 'RCC-5ca24d41:17ad69901c6:-7d11', 'CY', NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCC-5ca24d41:17ad69901c6:-7d11', 'RC-5ca24d41:17ad69901c6:-7d12', 'CurrentDate.year', 'year', 'CY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCC-5ca24d41:17ad69901c6:-7d1a', 'RC-5ca24d41:17ad69901c6:-7d1b', 'CurrentDate.year', 'year', 'CY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCC-5ca24d41:17ad69901c6:-7d1c', 'RC-5ca24d41:17ad69901c6:-7d1e', 'rptis.landtax.facts.RPTLedgerItemFact.year', 'year', NULL, 'less than or equal to', '<=', '1', 'RCC-5ca24d41:17ad69901c6:-7d1a', 'CY', NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCC-5ca24d41:17ad69901c6:-7d8a', 'RC-5ca24d41:17ad69901c6:-7d8b', 'CurrentDate.year', 'year', 'CY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCC-5ca24d41:17ad69901c6:-7d8c', 'RC-5ca24d41:17ad69901c6:-7d8f', 'rptis.landtax.facts.RPTLedgerItemFact.year', 'year', NULL, 'less than', '<', '1', 'RCC-5ca24d41:17ad69901c6:-7d8a', 'CY', NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCC-5ca24d41:17ad69901c6:-7d8d', 'RC-5ca24d41:17ad69901c6:-7d8f', 'rptis.landtax.facts.RPTLedgerItemFact.amtdue', 'amtdue', 'TAX', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCC-5ca24d41:17ad69901c6:-7d8e', 'RC-5ca24d41:17ad69901c6:-7d8f', 'rptis.landtax.facts.RPTLedgerItemFact.monthsfromjan', 'monthsfromjan', 'NMON', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCC-5ca24d41:17ad69901c6:-7d99', 'RC-5ca24d41:17ad69901c6:-7d9c', 'rptis.landtax.facts.RPTLedgerItemFact.year', 'year', NULL, 'less than or equal to', '<=', '0', NULL, NULL, NULL, '1991', NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCC-5ca24d41:17ad69901c6:-7d9a', 'RC-5ca24d41:17ad69901c6:-7d9c', 'rptis.landtax.facts.RPTLedgerItemFact.amtdue', 'amtdue', 'TAX', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCC-5ca24d41:17ad69901c6:-7dac', 'RC-5ca24d41:17ad69901c6:-7dae', 'rptis.landtax.facts.AssessedValue.av', 'av', 'PAV', 'less than', '<', '1', 'RCC-5ca24d41:17ad69901c6:-7daf', 'LAV', NULL, NULL, NULL, NULL, NULL, '1')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCC-5ca24d41:17ad69901c6:-7dad', 'RC-5ca24d41:17ad69901c6:-7dae', 'rptis.landtax.facts.AssessedValue.year', 'year', NULL, 'equal to', '==', NULL, NULL, NULL, NULL, '2000', NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCC-5ca24d41:17ad69901c6:-7daf', 'RC-5ca24d41:17ad69901c6:-7db1', 'rptis.landtax.facts.AssessedValue.av', 'av', 'LAV', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCC-5ca24d41:17ad69901c6:-7db0', 'RC-5ca24d41:17ad69901c6:-7db1', 'rptis.landtax.facts.AssessedValue.year', 'year', NULL, 'equal to', '==', NULL, NULL, NULL, NULL, '2003', NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCC-5ca24d41:17ad69901c6:-7db5', 'RC-5ca24d41:17ad69901c6:-7db7', 'rptis.landtax.facts.AssessedValue.year', 'year', NULL, 'equal to', '==', NULL, NULL, NULL, NULL, '2002', NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCC-5ca24d41:17ad69901c6:-7db6', 'RC-5ca24d41:17ad69901c6:-7db7', 'rptis.landtax.facts.AssessedValue.av', 'av', 'LAV', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCC-5ca24d41:17ad69901c6:-7db8', 'RC-5ca24d41:17ad69901c6:-7dba', 'rptis.landtax.facts.AssessedValue.year', 'year', NULL, 'equal to', '==', NULL, NULL, NULL, NULL, '2000', NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCC-5ca24d41:17ad69901c6:-7db9', 'RC-5ca24d41:17ad69901c6:-7dba', 'rptis.landtax.facts.AssessedValue.av', 'av', 'PAV', 'less than', '<', '1', NULL, 'LAV', NULL, NULL, NULL, NULL, NULL, '1')
go
...
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCC440e47f4:166ae4152f1:-7fbf', 'RC440e47f4:166ae4152f1:-7fc0', 'rptis.landtax.facts.RPTLedgerItemFact.year', 'year', NULL, 'greater than or equal to', '>=', '0', NULL, NULL, NULL, '1992', NULL, NULL, NULL, '0')
go
...
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-316d', 'RCOND-3c38a261:17ad6957651:-31bf', 'rptis.landtax.facts.RPTLedgerItemFact.year', 'year', NULL, 'less than or equal to', '<=', '1', 'RCONST-3c38a261:17ad6957651:-335a', 'CY', NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-329f', 'RCOND-3c38a261:17ad6957651:-32d7', 'rptis.landtax.facts.RPTLedgerFact.objid', 'objid', NULL, 'is any of the ff.', 'matches', NULL, NULL, NULL, NULL, NULL, NULL, '[[key:"FRPTL00071954",value:"2017-050014-0533"],[key:"FRPTL00077990",value:"2017-050012-0883"],[key:"FRPTL00071952",value:"2017-050014-0529"],[key:"FRPTL00080563",value:"2017-050010-0931"]]', NULL, '0')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-335a', 'RCOND-3c38a261:17ad6957651:-3376', 'CurrentDate.year', 'year', 'CY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-34e8', 'RC440e47f4:166ae4152f1:-7fc0', 'rptis.landtax.facts.RPTLedgerItemFact.year', 'year', NULL, 'less than', '<', '1', 'RCC440e47f4:166ae4152f1:-7fbd', 'CY', NULL, NULL, NULL, NULL, NULL, '1')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-382c', 'RC-5ca24d41:17ad69901c6:-7cdc', 'rptis.landtax.facts.RPTLedgerItemFact.qtr', 'qtr', NULL, 'greater than or equal to', '>=', '1', 'RCONST-3c38a261:17ad6957651:-3ad1', 'CQTR', NULL, NULL, NULL, NULL, NULL, '2')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-38ac', 'RC-5ca24d41:17ad69901c6:-7cdc', 'rptis.landtax.facts.RPTLedgerItemFact.fullypaid', 'fullypaid', NULL, 'is true', '== true', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-39fc', 'RC-5ca24d41:17ad69901c6:-7cde', 'rptis.landtax.facts.RPTLedgerFact.lastqtrpaid', 'lastqtrpaid', 'LQTR', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-3ad1', 'RC-5ca24d41:17ad69901c6:-7ce0', 'CurrentDate.qtr', 'qtr', 'CQTR', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-3d6e', 'RCOND-3c38a261:17ad6957651:-3dc0', 'rptis.landtax.facts.RPTLedgerItemFact.year', 'year', NULL, 'equal to', '==', '1', 'RCONST-3c38a261:17ad6957651:-3f68', 'CY', NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-3e42', 'RCOND-3c38a261:17ad6957651:-3ee7', 'rptis.landtax.facts.RPTLedgerFact.lastqtrpaid', 'lastqtrpaid', NULL, 'not equal to', '!=', NULL, NULL, NULL, NULL, '4', NULL, NULL, NULL, '1')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-3ea1', 'RCOND-3c38a261:17ad6957651:-3ee7', 'rptis.landtax.facts.RPTLedgerFact.lastyearpaid', 'lastyearpaid', NULL, 'equal to', '==', NULL, NULL, NULL, NULL, '2015', NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-3f68', 'RCOND-3c38a261:17ad6957651:-3f84', 'CurrentDate.year', 'year', 'CY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-4096', 'RCOND-3c38a261:17ad6957651:-411a', 'rptis.landtax.facts.RPTLedgerItemFact.backtax', 'backtax', NULL, 'is true', '== true', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-430b', 'RCOND-3c38a261:17ad6957651:-4402', 'rptis.landtax.facts.RPTLedgerItemFact.amtdue', 'amtdue', 'TAX', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-43b0', 'RCOND-3c38a261:17ad6957651:-4402', 'rptis.landtax.facts.RPTLedgerItemFact.year', 'year', NULL, 'equal to', '==', NULL, NULL, NULL, NULL, '2021', NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-45d9', 'RC-5ca24d41:17ad69901c6:-7d10', 'rptis.landtax.facts.RPTLedgerItemFact.backtax', 'backtax', NULL, 'is true', '== true', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-4783', 'RC-5ca24d41:17ad69901c6:-7d1e', 'rptis.landtax.facts.RPTLedgerItemFact.reclassed', 'reclassed', NULL, 'is true', '== true', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-49a6', 'RCOND-3c38a261:17ad6957651:-4a94', 'rptis.landtax.facts.RPTLedgerItemFact.taxdifference', 'taxdifference', NULL, 'is true', '== true', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-4a42', 'RCOND-3c38a261:17ad6957651:-4a94', 'rptis.landtax.facts.RPTLedgerItemFact.year', 'year', NULL, 'less than or equal to', '<=', '1', 'RCONST-3c38a261:17ad6957651:-4b29', 'CY', NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-4b29', 'RCOND-3c38a261:17ad6957651:-4b45', 'CurrentDate.year', 'year', 'CY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-4c3d', 'RCOND-3c38a261:17ad6957651:-4ce2', 'rptis.landtax.facts.RPTLedgerFact.lastqtrpaid', 'lastqtrpaid', NULL, 'equal to', '==', NULL, NULL, NULL, NULL, '4', NULL, NULL, NULL, '1')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-4c9c', 'RCOND-3c38a261:17ad6957651:-4ce2', 'rptis.landtax.facts.RPTLedgerFact.lastyearpaid', 'lastyearpaid', NULL, 'equal to', '==', '1', 'RCC7280357:166235c1be7:-7fcd', 'CY', NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-4e07', 'RC7280357:166235c1be7:-7fd4', 'rptis.landtax.facts.RPTLedgerItemFact.fullypaid', 'fullypaid', NULL, 'is true', '== true', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-512c', 'RCOND-3c38a261:17ad6957651:-52e1', 'rptis.landtax.facts.RPTLedgerItemFact.fullypaid', 'fullypaid', NULL, 'is true', '== true', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-5213', 'RCOND-3c38a261:17ad6957651:-52e1', 'rptis.landtax.facts.RPTLedgerItemFact.qtr', 'qtr', 'QTR', 'greater than or equal to', '>=', '1', 'RCONST-3c38a261:17ad6957651:-54a8', 'CQTR', NULL, NULL, NULL, NULL, NULL, '1')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-528f', 'RCOND-3c38a261:17ad6957651:-52e1', 'rptis.landtax.facts.RPTLedgerItemFact.year', 'year', NULL, 'equal to', '==', '1', 'RCONST-3c38a261:17ad6957651:-54e3', 'CY', NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-5365', 'RCOND-3c38a261:17ad6957651:-540a', 'rptis.landtax.facts.RPTLedgerFact.lastqtrpaid', 'lastqtrpaid', 'LQTR', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-53c4', 'RCOND-3c38a261:17ad6957651:-540a', 'rptis.landtax.facts.RPTLedgerFact.lastyearpaid', 'lastyearpaid', 'LYR', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-54a8', 'RCOND-3c38a261:17ad6957651:-54ff', 'CurrentDate.qtr', 'qtr', 'CQTR', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-54e3', 'RCOND-3c38a261:17ad6957651:-54ff', 'CurrentDate.year', 'year', 'CY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-5724', 'RCOND-3c38a261:17ad6957651:-5ad2', 'rptis.landtax.facts.RPTLedgerItemFact.qtr', 'qtr', 'QTR', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '4')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-5840', 'RCOND-3c38a261:17ad6957651:-5ad2', 'rptis.landtax.facts.RPTLedgerItemFact.monthsfromjan', 'monthsfromjan', 'NMONJ', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '3')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-591e', 'RCOND-3c38a261:17ad6957651:-5ad2', 'rptis.landtax.facts.RPTLedgerItemFact.monthsfromqtr', 'monthsfromqtr', 'NMONQ', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-59dc', 'RCOND-3c38a261:17ad6957651:-5ad2', 'rptis.landtax.facts.RPTLedgerItemFact.amtdue', 'amtdue', 'TAX', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-5a80', 'RCOND-3c38a261:17ad6957651:-5ad2', 'rptis.landtax.facts.RPTLedgerItemFact.year', 'year', NULL, 'equal to', '==', '1', 'RCONST-3c38a261:17ad6957651:-5d4f', 'CY', NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-5b58', 'RCOND-3c38a261:17ad6957651:-5c6a', 'rptis.landtax.facts.RPTLedgerFact.lastqtrpaid', 'lastqtrpaid', 'LQTR', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-5bc6', 'RCOND-3c38a261:17ad6957651:-5c6a', 'rptis.landtax.facts.RPTLedgerFact.lastyearpaid', 'lastyearpaid', 'LYR', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-5d14', 'RCOND-3c38a261:17ad6957651:-5d6b', 'CurrentDate.qtr', 'qtr', 'CQTR', NULL, NULL, NULL, NULL, NULL, NULL, '1', NULL, NULL, NULL, '1')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-5d4f', 'RCOND-3c38a261:17ad6957651:-5d6b', 'CurrentDate.year', 'year', 'CY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-5ec9', 'RC-5ca24d41:17ad69901c6:-7d8f', 'rptis.landtax.facts.RPTLedgerItemFact.year', 'year', NULL, 'greater than or equal to', '>=', NULL, NULL, NULL, NULL, '1992', NULL, NULL, NULL, '3')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-73bb', 'RC-5ca24d41:17ad69901c6:-7d9c', 'rptis.landtax.facts.RPTLedgerItemFact.monthsfromjan', 'monthsfromjan', 'NMON', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-78b5', 'RCOND-3c38a261:17ad6957651:-78b7', 'rptis.landtax.facts.AssessedValue.av', 'av', 'PAV', 'less than', '<', '1', 'RCONST-3c38a261:17ad6957651:-7901', 'LAV', NULL, NULL, NULL, NULL, NULL, '1')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-78b6', 'RCOND-3c38a261:17ad6957651:-78b7', 'rptis.landtax.facts.AssessedValue.year', 'year', NULL, 'equal to', '==', NULL, NULL, NULL, NULL, '2000', NULL, NULL, NULL, '0')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-7901', 'RCOND-3c38a261:17ad6957651:-7903', 'rptis.landtax.facts.AssessedValue.av', 'av', 'LAV', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1')
go
INSERT INTO sys_rule_condition_constraint ([objid], [parentid], [field_objid], [fieldname], [varname], [operator_caption], [operator_symbol], [usevar], [var_objid], [var_name], [decimalvalue], [intvalue], [stringvalue], [listvalue], [datevalue], [pos]) VALUES ('RCONST-3c38a261:17ad6957651:-7902', 'RCOND-3c38a261:17ad6957651:-7903', 'rptis.landtax.facts.AssessedValue.year', 'year', NULL, 'equal to', '==', NULL, NULL, NULL, NULL, '2001', NULL, NULL, NULL, '0')
go
...
go
INSERT INTO sys_rule_action ([objid], [parentid], [actiondef_objid], [actiondef_name], [pos]) VALUES ('RA-5ca24d41:17ad69901c6:-7cc3', 'RUL-3c38a261:17ad6957651:-364e', 'rptis.landtax.actions.CreateTaxSummary', 'create-tax-summary', '0')
go
INSERT INTO sys_rule_action ([objid], [parentid], [actiondef_objid], [actiondef_name], [pos]) VALUES ('RA-5ca24d41:17ad69901c6:-7cda', 'RUL-3c38a261:17ad6957651:-3b26', 'rptis.landtax.actions.CalcDiscount', 'calc-discount', '0')
go
INSERT INTO sys_rule_action ([objid], [parentid], [actiondef_objid], [actiondef_name], [pos]) VALUES ('RA-5ca24d41:17ad69901c6:-7ce7', 'RUL-3c38a261:17ad6957651:-3bf9', 'rptis.landtax.actions.CalcDiscount', 'calc-discount', '0')
go
INSERT INTO sys_rule_action ([objid], [parentid], [actiondef_objid], [actiondef_name], [pos]) VALUES ('RA-5ca24d41:17ad69901c6:-7d0d', 'RUL-3c38a261:17ad6957651:-4699', 'rptis.landtax.actions.CalcInterest', 'calc-interest', '0')
go
INSERT INTO sys_rule_action ([objid], [parentid], [actiondef_objid], [actiondef_name], [pos]) VALUES ('RA-5ca24d41:17ad69901c6:-7d19', 'RUL-3c38a261:17ad6957651:-48b3', 'rptis.landtax.actions.CalcInterest', 'calc-interest', '0')
go
INSERT INTO sys_rule_action ([objid], [parentid], [actiondef_objid], [actiondef_name], [pos]) VALUES ('RA-5ca24d41:17ad69901c6:-7d89', 'RUL-3c38a261:17ad6957651:-7285', 'rptis.landtax.actions.CalcInterest', 'calc-interest', '0')
go
INSERT INTO sys_rule_action ([objid], [parentid], [actiondef_objid], [actiondef_name], [pos]) VALUES ('RA-5ca24d41:17ad69901c6:-7d96', 'RUL-3c38a261:17ad6957651:-74ca', 'rptis.landtax.actions.CalcInterest', 'calc-interest', '0')
go
INSERT INTO sys_rule_action ([objid], [parentid], [actiondef_objid], [actiondef_name], [pos]) VALUES ('RA-5ca24d41:17ad69901c6:-7dab', 'RUL-3c38a261:17ad6957651:-763e', 'rptis.landtax.actions.UpdateAV', 'update-av', '0')
go
INSERT INTO sys_rule_action ([objid], [parentid], [actiondef_objid], [actiondef_name], [pos]) VALUES ('RA-5ca24d41:17ad69901c6:-7db4', 'RUL-3c38a261:17ad6957651:-76a1', 'rptis.landtax.actions.UpdateAV', 'update-av', '0')
go
...
go
INSERT INTO sys_rule_action ([objid], [parentid], [actiondef_objid], [actiondef_name], [pos]) VALUES ('RACT-3c38a261:17ad6957651:-3101', 'RUL-3c38a261:17ad6957651:-33ca', 'rptis.landtax.actions.CalcInterest', 'calc-interest', '0')
go
INSERT INTO sys_rule_action ([objid], [parentid], [actiondef_objid], [actiondef_name], [pos]) VALUES ('RACT-3c38a261:17ad6957651:-3c74', 'RUL-3c38a261:17ad6957651:-3fd6', 'rptis.landtax.actions.CalcDiscount', 'calc-discount', '0')
go
INSERT INTO sys_rule_action ([objid], [parentid], [actiondef_objid], [actiondef_name], [pos]) VALUES ('RACT-3c38a261:17ad6957651:-4039', 'RUL-3c38a261:17ad6957651:-4180', 'rptis.landtax.actions.CalcDiscount', 'calc-discount', '0')
go
INSERT INTO sys_rule_action ([objid], [parentid], [actiondef_objid], [actiondef_name], [pos]) VALUES ('RACT-3c38a261:17ad6957651:-4251', 'RUL-3c38a261:17ad6957651:-4513', 'rptis.landtax.actions.CalcInterest', 'calc-interest', '0')
go
INSERT INTO sys_rule_action ([objid], [parentid], [actiondef_objid], [actiondef_name], [pos]) VALUES ('RACT-3c38a261:17ad6957651:-492e', 'RUL-3c38a261:17ad6957651:-4b97', 'rptis.landtax.actions.CalcInterest', 'calc-interest', '0')
go
INSERT INTO sys_rule_action ([objid], [parentid], [actiondef_objid], [actiondef_name], [pos]) VALUES ('RACT-3c38a261:17ad6957651:-5086', 'RUL-3c38a261:17ad6957651:-5551', 'rptis.landtax.actions.CalcDiscount', 'calc-discount', '0')
go
INSERT INTO sys_rule_action ([objid], [parentid], [actiondef_objid], [actiondef_name], [pos]) VALUES ('RACT-3c38a261:17ad6957651:-561f', 'RUL-3c38a261:17ad6957651:-5dbd', 'rptis.landtax.actions.CalcInterest', 'calc-interest', '0')
go
INSERT INTO sys_rule_action ([objid], [parentid], [actiondef_objid], [actiondef_name], [pos]) VALUES ('RACT-3c38a261:17ad6957651:-7709', 'RUL-3c38a261:17ad6957651:-7c23', 'rptis.landtax.actions.UpdateAV', 'update-av', '0')
go
INSERT INTO sys_rule_action ([objid], [parentid], [actiondef_objid], [actiondef_name], [pos]) VALUES ('RACT-43adaf20:179c6921191:-4bb8', 'RUL-43adaf20:179c6921191:-4d61', 'rptis.land.actions.CalcMarketValue', 'calc-mv', '0')
go
INSERT INTO sys_rule_action ([objid], [parentid], [actiondef_objid], [actiondef_name], [pos]) VALUES ('RACT-43adaf20:179c6921191:-4e13', 'RUL-43adaf20:179c6921191:-4f03', 'rptis.land.actions.CalcBaseMarketValue', 'calc-bmv', '0')
go
INSERT INTO sys_rule_action ([objid], [parentid], [actiondef_objid], [actiondef_name], [pos]) VALUES ('RACT-43adaf20:179c6921191:-4fd2', 'RUL-43adaf20:179c6921191:-5152', 'rptis.land.actions.CalcBaseMarketValue', 'calc-bmv', '0')
go
...
go
INSERT INTO sys_rule_action ([objid], [parentid], [actiondef_objid], [actiondef_name], [pos]) VALUES ('RACT-5cc00751:179cb731d09:-69c7', 'RUL-5cc00751:179cb731d09:-6a11', 'AddRequirement', 'add-requirement', '0')
go
INSERT INTO sys_rule_action ([objid], [parentid], [actiondef_objid], [actiondef_name], [pos]) VALUES ('RACT-5cc00751:179cb731d09:-6d87', 'RUL-79a9a347:15cfcae84de:-6401', 'rptis.actions.AddDeriveVariable', 'add-derive-var', '0')
go
INSERT INTO sys_rule_action ([objid], [parentid], [actiondef_objid], [actiondef_name], [pos]) VALUES ('RACT-5cc00751:179cb731d09:-6f19', 'RUL1441128c:1471efa4c1c:-6c93', 'rptis.bldg.actions.CalcAssessLevel', 'calc-assess-level', '0')
go
INSERT INTO sys_rule_action ([objid], [parentid], [actiondef_objid], [actiondef_name], [pos]) VALUES ('RACT-5cc00751:179cb731d09:-704f', 'RUL1441128c:1471efa4c1c:-6eaa', 'rptis.bldg.actions.AddAssessmentInfo', 'add-assessment-info', '0')
go
INSERT INTO sys_rule_action ([objid], [parentid], [actiondef_objid], [actiondef_name], [pos]) VALUES ('RACT-5cc00751:179cb731d09:-7225', 'RUL-2486b0ca:146fff66c3e:-2c4a', 'rptis.bldg.actions.CalcBldgUseMV', 'calc-bldguse-mv', '0')
go
INSERT INTO sys_rule_action ([objid], [parentid], [actiondef_objid], [actiondef_name], [pos]) VALUES ('RACT-5cc00751:179cb731d09:-7353', 'RUL-2486b0ca:146fff66c3e:-38e4', 'rptis.bldg.actions.CalcFloorMV', 'calc-floor-mv', '0')
go
INSERT INTO sys_rule_action ([objid], [parentid], [actiondef_objid], [actiondef_name], [pos]) VALUES ('RACT-5cc00751:179cb731d09:-74ba', 'RUL-2486b0ca:146fff66c3e:-4192', 'rptis.bldg.actions.CalcBldgUseDepreciation', 'calc-bldguse-depreciation', '0')
go
INSERT INTO sys_rule_action ([objid], [parentid], [actiondef_objid], [actiondef_name], [pos]) VALUES ('RACT-5cc00751:179cb731d09:-773a', 'RUL-2486b0ca:146fff66c3e:-4697', 'rptis.bldg.actions.CalcDepreciationFromSked', 'calc-depreciation-sked', '0')
go
INSERT INTO sys_rule_action ([objid], [parentid], [actiondef_objid], [actiondef_name], [pos]) VALUES ('RACT-5cc00751:179cb731d09:-798a', 'RUL-60c99d04:1470b276e7f:-7ecc', 'rptis.bldg.actions.CalcBldgUseBMV', 'calc-bldguse-bmv', '0')
go
INSERT INTO sys_rule_action ([objid], [parentid], [actiondef_objid], [actiondef_name], [pos]) VALUES ('RACT-5cc00751:179cb731d09:-7b5d', 'RUL-2486b0ca:146fff66c3e:-6b05', 'rptis.bldg.actions.CalcFloorBMV', 'calc-floor-bmv', '0')
go
INSERT INTO sys_rule_action ([objid], [parentid], [actiondef_objid], [actiondef_name], [pos]) VALUES ('RACT-5cc00751:179cb731d09:-7d42', 'RUL3e2b89cb:146ff734573:-7dcc', 'rptis.bldg.actions.CalcBldgAge', 'calc-bldg-age', '0')
go
...
go
INSERT INTO sys_rule_action ([objid], [parentid], [actiondef_objid], [actiondef_name], [pos]) VALUES ('RACT-79a9a347:15cfcae84de:-5e1c', 'RUL-79a9a347:15cfcae84de:-6401', 'RULADEF1b4af871:14e3cc46e09:-344d', 'add-derive-var', '0')
go
...
go
INSERT INTO sys_rule_actiondef_param ([objid], [parentid], [name], [sortorder], [title], [datatype], [handler], [lookuphandler], [lookupkey], [lookupvalue], [vardatatype], [lovname]) VALUES ('rptis.bldg.actions.CalcDepreciationFromSked.bldgst', 'rptis.bldg.actions.CalcDepreciationFromSked', 'bldgstructure', '1', 'Building Structure', NULL, 'var', NULL, NULL, NULL, 'rptis.bldg.facts.BldgStructure', NULL)
go
...
go
INSERT INTO sys_rule_actiondef_param ([objid], [parentid], [name], [sortorder], [title], [datatype], [handler], [lookuphandler], [lookupkey], [lookupvalue], [vardatatype], [lovname]) VALUES ('rptis.land.actions.AddAssessmentInfo.classificatio', 'rptis.land.actions.AddAssessmentInfo', 'classification', '2', 'Classification', NULL, 'var', NULL, NULL, NULL, 'rptis.facts.Classification', NULL)
go
...
go
INSERT INTO sys_rule_actiondef_param ([objid], [parentid], [name], [sortorder], [title], [datatype], [handler], [lookuphandler], [lookupkey], [lookupvalue], [vardatatype], [lovname]) VALUES ('rptis.land.actions.UpdateLandDetailAdjustment.land', 'rptis.land.actions.UpdateLandDetailAdjustment', 'landdetail', '1', 'Land Item Appraisal', NULL, 'var', NULL, NULL, NULL, 'rptis.land.facts.LandDetail', NULL)
go
INSERT INTO sys_rule_actiondef_param ([objid], [parentid], [name], [sortorder], [title], [datatype], [handler], [lookuphandler], [lookupkey], [lookupvalue], [vardatatype], [lovname]) VALUES ('rptis.land.actions.UpdateLandDetailValueAdjustment', 'rptis.land.actions.UpdateLandDetailValueAdjustment', 'expr', '2', 'Computation', NULL, 'expression', NULL, NULL, NULL, NULL, NULL)
go
...
go
INSERT INTO sys_rule_actiondef_param ([objid], [parentid], [name], [sortorder], [title], [datatype], [handler], [lookuphandler], [lookupkey], [lookupvalue], [vardatatype], [lovname]) VALUES ('rptis.landtax.actions.AggregateLedgerItem.rptledge', 'rptis.landtax.actions.AggregateLedgerItem', 'rptledgeritem', '1', 'Ledger Item', NULL, 'var', NULL, NULL, NULL, 'rptis.landtax.facts.RPTLedgerItemFact', NULL)
go
...
go
INSERT INTO sys_rule_actiondef_param ([objid], [parentid], [name], [sortorder], [title], [datatype], [handler], [lookuphandler], [lookupkey], [lookupvalue], [vardatatype], [lovname]) VALUES ('rptis.landtax.actions.CreateTaxSummary.rptledgerit', 'rptis.landtax.actions.CreateTaxSummary', 'rptledgeritem', '1', 'RPT Ledger Item', '', 'var', '', '', '', 'rptis.landtax.facts.RPTLedgerItemFact', '')
go
...
go
INSERT INTO sys_rule_actiondef_param ([objid], [parentid], [name], [sortorder], [title], [datatype], [handler], [lookuphandler], [lookupkey], [lookupvalue], [vardatatype], [lovname]) VALUES ('rptis.landtax.actions.SplitLedgerItem.rptledgerite', 'rptis.landtax.actions.SplitLedgerItem', 'rptledgeritem', '1', 'Ledger Item', NULL, 'var', NULL, NULL, NULL, 'rptis.landtax.facts.RPTLedgerItemFact', NULL)
go
...
go
INSERT INTO sys_rule_actiondef_param ([objid], [parentid], [name], [sortorder], [title], [datatype], [handler], [lookuphandler], [lookupkey], [lookupvalue], [vardatatype], [lovname]) VALUES ('rptis.misc.actions.CalcMiscRPUBaseMarketValue.misc', 'rptis.misc.actions.CalcMiscRPUBaseMarketValue', 'miscrpu', '1', 'Miscellaneous RPU', NULL, 'var', NULL, NULL, NULL, 'rptis.misc.facts.MiscRPU', NULL)
go
...
go
INSERT INTO sys_rule_actiondef_param ([objid], [parentid], [name], [sortorder], [title], [datatype], [handler], [lookuphandler], [lookupkey], [lookupvalue], [vardatatype], [lovname]) VALUES ('rptis.planttree.actions.AddPlantTreeAssessmentInfo', 'rptis.planttree.actions.AddPlantTreeAssessmentInfo', 'planttreedetail', '1', 'Plant/Tree', NULL, 'var', NULL, NULL, NULL, 'rptis.planttree.facts.PlantTreeDetail', NULL)
go
INSERT INTO sys_rule_actiondef_param ([objid], [parentid], [name], [sortorder], [title], [datatype], [handler], [lookuphandler], [lookupkey], [lookupvalue], [vardatatype], [lovname]) VALUES ('rptis.planttree.actions.CalcPlantTreeAdjustment.ex', 'rptis.planttree.actions.CalcPlantTreeAdjustment', 'expr', '2', 'Computation', NULL, 'expression', NULL, NULL, NULL, NULL, NULL)
go
INSERT INTO sys_rule_actiondef_param ([objid], [parentid], [name], [sortorder], [title], [datatype], [handler], [lookuphandler], [lookupkey], [lookupvalue], [vardatatype], [lovname]) VALUES ('rptis.planttree.actions.CalcPlantTreeAdjustment.pl', 'rptis.planttree.actions.CalcPlantTreeAdjustment', 'planttreedetail', '1', 'Plant/Tree Appraisal', NULL, 'var', NULL, NULL, NULL, 'rptis.planttree.facts.PlantTreeDetail', NULL)
go
INSERT INTO sys_rule_actiondef_param ([objid], [parentid], [name], [sortorder], [title], [datatype], [handler], [lookuphandler], [lookupkey], [lookupvalue], [vardatatype], [lovname]) VALUES ('rptis.planttree.actions.CalcPlantTreeAssessValue.e', 'rptis.planttree.actions.CalcPlantTreeAssessValue', 'expr', '2', 'Computation', NULL, 'expression', NULL, NULL, NULL, NULL, NULL)
go
INSERT INTO sys_rule_actiondef_param ([objid], [parentid], [name], [sortorder], [title], [datatype], [handler], [lookuphandler], [lookupkey], [lookupvalue], [vardatatype], [lovname]) VALUES ('rptis.planttree.actions.CalcPlantTreeAssessValue.p', 'rptis.planttree.actions.CalcPlantTreeAssessValue', 'planttreedetail', '1', 'Plant/Tree Appraisal', NULL, 'var', NULL, NULL, NULL, 'rptis.planttree.facts.PlantTreeDetail', NULL)
go
...
go
INSERT INTO sys_rule_actiondef_param ([objid], [parentid], [name], [sortorder], [title], [datatype], [handler], [lookuphandler], [lookupkey], [lookupvalue], [vardatatype], [lovname]) VALUES ('rptis.planttree.actions.CalcPlantTreeBMV.planttree', 'rptis.planttree.actions.CalcPlantTreeBMV', 'planttreedetail', '1', 'Plant/Tree Appraisal', NULL, 'var', NULL, NULL, NULL, 'rptis.planttree.facts.PlantTreeDetail', NULL)
go
INSERT INTO sys_rule_actiondef_param ([objid], [parentid], [name], [sortorder], [title], [datatype], [handler], [lookuphandler], [lookupkey], [lookupvalue], [vardatatype], [lovname]) VALUES ('rptis.planttree.actions.CalcPlantTreeMarketValue.e', 'rptis.planttree.actions.CalcPlantTreeMarketValue', 'expr', '2', 'Computation', NULL, 'expression', NULL, NULL, NULL, NULL, NULL)
go
INSERT INTO sys_rule_actiondef_param ([objid], [parentid], [name], [sortorder], [title], [datatype], [handler], [lookuphandler], [lookupkey], [lookupvalue], [vardatatype], [lovname]) VALUES ('rptis.planttree.actions.CalcPlantTreeMarketValue.p', 'rptis.planttree.actions.CalcPlantTreeMarketValue', 'planttreedetail', '1', 'Plant/Tree Appraisal', NULL, 'var', NULL, NULL, NULL, 'rptis.planttree.facts.PlantTreeDetail', NULL)
go
...
go
INSERT INTO sys_rule_action_param ([objid], [parentid], [actiondefparam_objid], [stringvalue], [booleanvalue], [var_objid], [var_name], [expr], [exprtype], [pos], [obj_key], [obj_value], [listvalue], [lov], [rangeoption]) VALUES ('RAP-5ca24d41:17ad69901c6:-7cc1', 'RA-5ca24d41:17ad69901c6:-7cc3', 'rptis.landtax.actions.CreateTaxSummary.revperiod', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'prior', NULL)
go
INSERT INTO sys_rule_action_param ([objid], [parentid], [actiondefparam_objid], [stringvalue], [booleanvalue], [var_objid], [var_name], [expr], [exprtype], [pos], [obj_key], [obj_value], [listvalue], [lov], [rangeoption]) VALUES ('RAP-5ca24d41:17ad69901c6:-7cc2', 'RA-5ca24d41:17ad69901c6:-7cc3', 'rptis.landtax.actions.CreateTaxSummary.rptledgerit', NULL, NULL, 'RC-5ca24d41:17ad69901c6:-7cc5', 'RLI', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL)
go
INSERT INTO sys_rule_action_param ([objid], [parentid], [actiondefparam_objid], [stringvalue], [booleanvalue], [var_objid], [var_name], [expr], [exprtype], [pos], [obj_key], [obj_value], [listvalue], [lov], [rangeoption]) VALUES ('RAP-5ca24d41:17ad69901c6:-7cd8', 'RA-5ca24d41:17ad69901c6:-7cda', 'rptis.landtax.actions.CalcDiscount.expr', NULL, NULL, NULL, NULL, 'if ( LQTR == 1 && CQTR == 3 ) return TAX * 0.10;
if ( LQTR == 2 && CQTR == 3 ) return TAX * 0.10;
if ( LQTR == 3 && CQTR == 3 ) return TAX * 0.10;
return 0;', 'expression', NULL, NULL, NULL, NULL, NULL, NULL)
go 
INSERT INTO sys_rule_action_param ([objid], [parentid], [actiondefparam_objid], [stringvalue], [booleanvalue], [var_objid], [var_name], [expr], [exprtype], [pos], [obj_key], [obj_value], [listvalue], [lov], [rangeoption]) VALUES ('RAP-5ca24d41:17ad69901c6:-7cd9', 'RA-5ca24d41:17ad69901c6:-7cda', 'rptis.landtax.actions.CalcDiscount.rptledgeritem', NULL, NULL, 'RC-5ca24d41:17ad69901c6:-7cdc', 'RLI', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL)
go
INSERT INTO sys_rule_action_param ([objid], [parentid], [actiondefparam_objid], [stringvalue], [booleanvalue], [var_objid], [var_name], [expr], [exprtype], [pos], [obj_key], [obj_value], [listvalue], [lov], [rangeoption]) VALUES ('RAP-5ca24d41:17ad69901c6:-7ce5', 'RA-5ca24d41:17ad69901c6:-7ce7', 'rptis.landtax.actions.CalcDiscount.rptledgeritem', NULL, NULL, 'RC-5ca24d41:17ad69901c6:-7cee', 'RLI', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL)
go
INSERT INTO sys_rule_action_param ([objid], [parentid], [actiondefparam_objid], [stringvalue], [booleanvalue], [var_objid], [var_name], [expr], [exprtype], [pos], [obj_key], [obj_value], [listvalue], [lov], [rangeoption]) VALUES ('RAP-5ca24d41:17ad69901c6:-7ce6', 'RA-5ca24d41:17ad69901c6:-7ce7', 'rptis.landtax.actions.CalcDiscount.expr', NULL, NULL, NULL, NULL, '0', 'expression', NULL, NULL, NULL, NULL, NULL, NULL)
go
INSERT INTO sys_rule_action_param ([objid], [parentid], [actiondefparam_objid], [stringvalue], [booleanvalue], [var_objid], [var_name], [expr], [exprtype], [pos], [obj_key], [obj_value], [listvalue], [lov], [rangeoption]) VALUES ('RAP-5ca24d41:17ad69901c6:-7d0b', 'RA-5ca24d41:17ad69901c6:-7d0d', 'rptis.landtax.actions.CalcInterest.expr', NULL, NULL, NULL, NULL, '0', 'expression', NULL, NULL, NULL, NULL, NULL, NULL)
go
INSERT INTO sys_rule_action_param ([objid], [parentid], [actiondefparam_objid], [stringvalue], [booleanvalue], [var_objid], [var_name], [expr], [exprtype], [pos], [obj_key], [obj_value], [listvalue], [lov], [rangeoption]) VALUES ('RAP-5ca24d41:17ad69901c6:-7d0c', 'RA-5ca24d41:17ad69901c6:-7d0d', 'rptis.landtax.actions.CalcInterest.rptledgeritem', NULL, NULL, 'RC-5ca24d41:17ad69901c6:-7d10', 'RLI', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL)
go
INSERT INTO sys_rule_action_param ([objid], [parentid], [actiondefparam_objid], [stringvalue], [booleanvalue], [var_objid], [var_name], [expr], [exprtype], [pos], [obj_key], [obj_value], [listvalue], [lov], [rangeoption]) VALUES ('RAP-5ca24d41:17ad69901c6:-7d17', 'RA-5ca24d41:17ad69901c6:-7d19', 'rptis.landtax.actions.CalcInterest.rptledgeritem', NULL, NULL, 'RC-5ca24d41:17ad69901c6:-7d1e', 'RLI', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL)
go
INSERT INTO sys_rule_action_param ([objid], [parentid], [actiondefparam_objid], [stringvalue], [booleanvalue], [var_objid], [var_name], [expr], [exprtype], [pos], [obj_key], [obj_value], [listvalue], [lov], [rangeoption]) VALUES ('RAP-5ca24d41:17ad69901c6:-7d18', 'RA-5ca24d41:17ad69901c6:-7d19', 'rptis.landtax.actions.CalcInterest.expr', NULL, NULL, NULL, NULL, '0', 'expression', NULL, NULL, NULL, NULL, NULL, NULL)
go
INSERT INTO sys_rule_action_param ([objid], [parentid], [actiondefparam_objid], [stringvalue], [booleanvalue], [var_objid], [var_name], [expr], [exprtype], [pos], [obj_key], [obj_value], [listvalue], [lov], [rangeoption]) VALUES ('RAP-5ca24d41:17ad69901c6:-7d87', 'RA-5ca24d41:17ad69901c6:-7d89', 'rptis.landtax.actions.CalcInterest.rptledgeritem', NULL, NULL, 'RC-5ca24d41:17ad69901c6:-7d8f', 'RLI', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL)
go
INSERT INTO sys_rule_action_param ([objid], [parentid], [actiondefparam_objid], [stringvalue], [booleanvalue], [var_objid], [var_name], [expr], [exprtype], [pos], [obj_key], [obj_value], [listvalue], [lov], [rangeoption]) VALUES ('RAP-5ca24d41:17ad69901c6:-7d88', 'RA-5ca24d41:17ad69901c6:-7d89', 'rptis.landtax.actions.CalcInterest.expr', NULL, NULL, NULL, NULL, '@IIF(  NMON * 0.02 > 0.72,  TAX * 0.72 , NMON * 0.02 * TAX  )', 'expression', NULL, NULL, NULL, NULL, NULL, NULL)
go
INSERT INTO sys_rule_action_param ([objid], [parentid], [actiondefparam_objid], [stringvalue], [booleanvalue], [var_objid], [var_name], [expr], [exprtype], [pos], [obj_key], [obj_value], [listvalue], [lov], [rangeoption]) VALUES ('RAP-5ca24d41:17ad69901c6:-7d94', 'RA-5ca24d41:17ad69901c6:-7d96', 'rptis.landtax.actions.CalcInterest.rptledgeritem', NULL, NULL, 'RC-5ca24d41:17ad69901c6:-7d9c', 'RLI', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL)
go
INSERT INTO sys_rule_action_param ([objid], [parentid], [actiondefparam_objid], [stringvalue], [booleanvalue], [var_objid], [var_name], [expr], [exprtype], [pos], [obj_key], [obj_value], [listvalue], [lov], [rangeoption]) VALUES ('RAP-5ca24d41:17ad69901c6:-7d95', 'RA-5ca24d41:17ad69901c6:-7d96', 'rptis.landtax.actions.CalcInterest.expr', NULL, NULL, NULL, NULL, 'TAX * NMON * 0.02', 'expression', NULL, NULL, NULL, NULL, NULL, NULL)
go
INSERT INTO sys_rule_action_param ([objid], [parentid], [actiondefparam_objid], [stringvalue], [booleanvalue], [var_objid], [var_name], [expr], [exprtype], [pos], [obj_key], [obj_value], [listvalue], [lov], [rangeoption]) VALUES ('RAP-5ca24d41:17ad69901c6:-7da9', 'RA-5ca24d41:17ad69901c6:-7dab', 'rptis.landtax.actions.UpdateAV.expr', NULL, NULL, NULL, NULL, '(LAV - PAV) * 0.75 + PAV', 'expression', NULL, NULL, NULL, NULL, NULL, NULL)
go
INSERT INTO sys_rule_action_param ([objid], [parentid], [actiondefparam_objid], [stringvalue], [booleanvalue], [var_objid], [var_name], [expr], [exprtype], [pos], [obj_key], [obj_value], [listvalue], [lov], [rangeoption]) VALUES ('RAP-5ca24d41:17ad69901c6:-7daa', 'RA-5ca24d41:17ad69901c6:-7dab', 'rptis.landtax.actions.UpdateAV.avfact', NULL, NULL, 'RC-5ca24d41:17ad69901c6:-7db1', 'AVINFO', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL)
go
INSERT INTO sys_rule_action_param ([objid], [parentid], [actiondefparam_objid], [stringvalue], [booleanvalue], [var_objid], [var_name], [expr], [exprtype], [pos], [obj_key], [obj_value], [listvalue], [lov], [rangeoption]) VALUES ('RAP-5ca24d41:17ad69901c6:-7db2', 'RA-5ca24d41:17ad69901c6:-7db4', 'rptis.landtax.actions.UpdateAV.avfact', NULL, NULL, 'RC-5ca24d41:17ad69901c6:-7db7', 'AVINFO', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL)
go
INSERT INTO sys_rule_action_param ([objid], [parentid], [actiondefparam_objid], [stringvalue], [booleanvalue], [var_objid], [var_name], [expr], [exprtype], [pos], [obj_key], [obj_value], [listvalue], [lov], [rangeoption]) VALUES ('RAP-5ca24d41:17ad69901c6:-7db3', 'RA-5ca24d41:17ad69901c6:-7db4', 'rptis.landtax.actions.UpdateAV.expr', NULL, NULL, NULL, NULL, '(LAV - PAV) * 0.50 + PAV', 'expression', NULL, NULL, NULL, NULL, NULL, NULL)
go
...
go
INSERT INTO sys_rule_action_param ([objid], [parentid], [actiondefparam_objid], [stringvalue], [booleanvalue], [var_objid], [var_name], [expr], [exprtype], [pos], [obj_key], [obj_value], [listvalue], [lov], [rangeoption]) VALUES ('RAP7280357:166235c1be7:-7fcb', 'RA7280357:166235c1be7:-7fcc', 'rptis.landtax.actions.CalcDiscount.expr', NULL, NULL, NULL, NULL, '@ROUND(TAX * 0.15)', 'expression', NULL, NULL, NULL, NULL, NULL, NULL)
go
...
go
INSERT INTO sys_rule_action_param ([objid], [parentid], [actiondefparam_objid], [stringvalue], [booleanvalue], [var_objid], [var_name], [expr], [exprtype], [pos], [obj_key], [obj_value], [listvalue], [lov], [rangeoption]) VALUES ('RULACT-3c38a261:17ad6957651:-30db', 'RACT-3c38a261:17ad6957651:-3101', 'rptis.landtax.actions.CalcInterest.expr', NULL, NULL, NULL, NULL, '0', 'expression', NULL, NULL, NULL, NULL, NULL, NULL)
go
INSERT INTO sys_rule_action_param ([objid], [parentid], [actiondefparam_objid], [stringvalue], [booleanvalue], [var_objid], [var_name], [expr], [exprtype], [pos], [obj_key], [obj_value], [listvalue], [lov], [rangeoption]) VALUES ('RULACT-3c38a261:17ad6957651:-30f1', 'RACT-3c38a261:17ad6957651:-3101', 'rptis.landtax.actions.CalcInterest.rptledgeritem', NULL, NULL, 'RCOND-3c38a261:17ad6957651:-31bf', 'RLI', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL)
go
INSERT INTO sys_rule_action_param ([objid], [parentid], [actiondefparam_objid], [stringvalue], [booleanvalue], [var_objid], [var_name], [expr], [exprtype], [pos], [obj_key], [obj_value], [listvalue], [lov], [rangeoption]) VALUES ('RULACT-3c38a261:17ad6957651:-3c4e', 'RACT-3c38a261:17ad6957651:-3c74', 'rptis.landtax.actions.CalcDiscount.expr', NULL, NULL, NULL, NULL, '0', 'expression', NULL, NULL, NULL, NULL, NULL, NULL)
go
INSERT INTO sys_rule_action_param ([objid], [parentid], [actiondefparam_objid], [stringvalue], [booleanvalue], [var_objid], [var_name], [expr], [exprtype], [pos], [obj_key], [obj_value], [listvalue], [lov], [rangeoption]) VALUES ('RULACT-3c38a261:17ad6957651:-3c64', 'RACT-3c38a261:17ad6957651:-3c74', 'rptis.landtax.actions.CalcDiscount.rptledgeritem', NULL, NULL, 'RCOND-3c38a261:17ad6957651:-3dc0', 'RLI', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL)
go
INSERT INTO sys_rule_action_param ([objid], [parentid], [actiondefparam_objid], [stringvalue], [booleanvalue], [var_objid], [var_name], [expr], [exprtype], [pos], [obj_key], [obj_value], [listvalue], [lov], [rangeoption]) VALUES ('RULACT-3c38a261:17ad6957651:-4013', 'RACT-3c38a261:17ad6957651:-4039', 'rptis.landtax.actions.CalcDiscount.expr', NULL, NULL, NULL, NULL, '0', 'expression', NULL, NULL, NULL, NULL, NULL, NULL)
go
INSERT INTO sys_rule_action_param ([objid], [parentid], [actiondefparam_objid], [stringvalue], [booleanvalue], [var_objid], [var_name], [expr], [exprtype], [pos], [obj_key], [obj_value], [listvalue], [lov], [rangeoption]) VALUES ('RULACT-3c38a261:17ad6957651:-4029', 'RACT-3c38a261:17ad6957651:-4039', 'rptis.landtax.actions.CalcDiscount.rptledgeritem', NULL, NULL, 'RCOND-3c38a261:17ad6957651:-411a', 'RLI', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL)
go
INSERT INTO sys_rule_action_param ([objid], [parentid], [actiondefparam_objid], [stringvalue], [booleanvalue], [var_objid], [var_name], [expr], [exprtype], [pos], [obj_key], [obj_value], [listvalue], [lov], [rangeoption]) VALUES ('RULACT-3c38a261:17ad6957651:-422b', 'RACT-3c38a261:17ad6957651:-4251', 'rptis.landtax.actions.CalcInterest.expr', NULL, NULL, NULL, NULL, '0', 'expression', NULL, NULL, NULL, NULL, NULL, NULL)
go
INSERT INTO sys_rule_action_param ([objid], [parentid], [actiondefparam_objid], [stringvalue], [booleanvalue], [var_objid], [var_name], [expr], [exprtype], [pos], [obj_key], [obj_value], [listvalue], [lov], [rangeoption]) VALUES ('RULACT-3c38a261:17ad6957651:-4241', 'RACT-3c38a261:17ad6957651:-4251', 'rptis.landtax.actions.CalcInterest.rptledgeritem', NULL, NULL, 'RCOND-3c38a261:17ad6957651:-4402', 'RLI', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL)
go
INSERT INTO sys_rule_action_param ([objid], [parentid], [actiondefparam_objid], [stringvalue], [booleanvalue], [var_objid], [var_name], [expr], [exprtype], [pos], [obj_key], [obj_value], [listvalue], [lov], [rangeoption]) VALUES ('RULACT-3c38a261:17ad6957651:-4908', 'RACT-3c38a261:17ad6957651:-492e', 'rptis.landtax.actions.CalcInterest.expr', NULL, NULL, NULL, NULL, '0', 'expression', NULL, NULL, NULL, NULL, NULL, NULL)
go
INSERT INTO sys_rule_action_param ([objid], [parentid], [actiondefparam_objid], [stringvalue], [booleanvalue], [var_objid], [var_name], [expr], [exprtype], [pos], [obj_key], [obj_value], [listvalue], [lov], [rangeoption]) VALUES ('RULACT-3c38a261:17ad6957651:-491e', 'RACT-3c38a261:17ad6957651:-492e', 'rptis.landtax.actions.CalcInterest.rptledgeritem', NULL, NULL, 'RCOND-3c38a261:17ad6957651:-4a94', 'RLI', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL)
go
INSERT INTO sys_rule_action_param ([objid], [parentid], [actiondefparam_objid], [stringvalue], [booleanvalue], [var_objid], [var_name], [expr], [exprtype], [pos], [obj_key], [obj_value], [listvalue], [lov], [rangeoption]) VALUES ('RULACT-3c38a261:17ad6957651:-5060', 'RACT-3c38a261:17ad6957651:-5086', 'rptis.landtax.actions.CalcDiscount.expr', NULL, NULL, NULL, NULL, 'if ( LYR == CY && LQTR > CQTR - 1 ) return TAX * 0.10;
if ( LYR == CY && LQTR == CQTR - 1 ) return TAX * 0.10;
if ( LYR == CY - 1 && LQTR == 4 && CQTR == 1 ) return TAX * 0.10;
return 0.00;', 'expression', NULL, NULL, NULL, NULL, NULL, NULL)
go
INSERT INTO sys_rule_action_param ([objid], [parentid], [actiondefparam_objid], [stringvalue], [booleanvalue], [var_objid], [var_name], [expr], [exprtype], [pos], [obj_key], [obj_value], [listvalue], [lov], [rangeoption]) VALUES ('RULACT-3c38a261:17ad6957651:-5076', 'RACT-3c38a261:17ad6957651:-5086', 'rptis.landtax.actions.CalcDiscount.rptledgeritem', NULL, NULL, 'RCOND-3c38a261:17ad6957651:-52e1', 'RLI', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL)
go
INSERT INTO sys_rule_action_param ([objid], [parentid], [actiondefparam_objid], [stringvalue], [booleanvalue], [var_objid], [var_name], [expr], [exprtype], [pos], [obj_key], [obj_value], [listvalue], [lov], [rangeoption]) VALUES ('RULACT-3c38a261:17ad6957651:-55f9', 'RACT-3c38a261:17ad6957651:-561f', 'rptis.landtax.actions.CalcInterest.expr', NULL, NULL, NULL, NULL, 'if ( LYR == CY - 1 ) return TAX * NMONJ * 0.02;
if ( LYR == CY && CQTR < QTR && LQTR > 1 ) return TAX * NMONJ * 0.02;
if ( LYR == CY && CQTR > QTR && LQTR > 1 ) return TAX * NMONQ * 0.02;
return 0.0;', 'expression', NULL, NULL, NULL, NULL, NULL, NULL)
go
INSERT INTO sys_rule_action_param ([objid], [parentid], [actiondefparam_objid], [stringvalue], [booleanvalue], [var_objid], [var_name], [expr], [exprtype], [pos], [obj_key], [obj_value], [listvalue], [lov], [rangeoption]) VALUES ('RULACT-3c38a261:17ad6957651:-560f', 'RACT-3c38a261:17ad6957651:-561f', 'rptis.landtax.actions.CalcInterest.rptledgeritem', NULL, NULL, 'RCOND-3c38a261:17ad6957651:-5ad2', 'RLI', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL)
go
INSERT INTO sys_rule_action_param ([objid], [parentid], [actiondefparam_objid], [stringvalue], [booleanvalue], [var_objid], [var_name], [expr], [exprtype], [pos], [obj_key], [obj_value], [listvalue], [lov], [rangeoption]) VALUES ('RULACT-3c38a261:17ad6957651:-76e1', 'RACT-3c38a261:17ad6957651:-7709', 'rptis.landtax.actions.UpdateAV.expr', NULL, NULL, NULL, NULL, '(LAV - PAV) * 0.25 + PAV', 'expression', NULL, NULL, NULL, NULL, NULL, NULL)
go
INSERT INTO sys_rule_action_param ([objid], [parentid], [actiondefparam_objid], [stringvalue], [booleanvalue], [var_objid], [var_name], [expr], [exprtype], [pos], [obj_key], [obj_value], [listvalue], [lov], [rangeoption]) VALUES ('RULACT-3c38a261:17ad6957651:-76f9', 'RACT-3c38a261:17ad6957651:-7709', 'rptis.landtax.actions.UpdateAV.avfact', NULL, NULL, 'RCOND-3c38a261:17ad6957651:-7903', 'AVINFO', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL)
go
...
exec usp_droptable 'batchgr_items_forrevision'
go 
exec usp_droptable 'batchgr_items_revised'
go 
exec usp_droptable 'batchgr_item'
go 
exec usp_droptable 'batchgr_task'
go 
exec usp_droptable 'batchgr'
go 
...
exec usp_dropview 'vw_landtax_lgu_account_mapping'
go 
