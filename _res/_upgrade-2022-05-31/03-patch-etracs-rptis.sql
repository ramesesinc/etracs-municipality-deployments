...
CREATE TABLE `rptledger_restriction` (
  ...
  PRIMARY KEY (`objid`),
  UNIQUE KEY `ux_rptledger_restriction` (`parentid`,`restrictionid`) USING BTREE,
  CONSTRAINT `rptledger_restriction_ibfk_1` FOREIGN KEY (`parentid`) REFERENCES `rptledger` (`objid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8
;
